 ...
 * @author dell
 */
public class UserAgentStatisticsReportParamsPanel extends javax.swing.JPanel {
    private Vector<Pair<Integer,String>> _coalFiles;
    private UserAgentStatisticsReportReaultsPanel _resultsPanel;
    /**
     * Creates new form RequestsPercentagePerHeaderReportParametersPanel
     */
    public UserAgentStatisticsReportParamsPanel(UserAgentStatisticsReportReaultsPanel resultsPanel) {
        initComponents();
     ...
     * Creates new form RequestsPercentagePerHeaderReportParametersPanel
     */
    public UserAgentStatisticsReportParamsPanel(Vector<Pair<Integer,String>> coalFiles, UserAgentStatisticsReportReaultsPanel resultsPanel) {
        initComponents();
