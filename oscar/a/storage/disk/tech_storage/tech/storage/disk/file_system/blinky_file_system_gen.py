...
from a.api.yang.modules.tech.common.qwilt_tech_storage_disk.tech.storage.disk.file_system.file_system_data_gen import FileSystemData


from a.storage.disk.tech_storage.tech.storage.disk.file_system.commands.blinky_commands_gen import BlinkyCommands

from a.storage.disk.tech_storage.tech.storage.disk.file_system.timeouts.blinky_timeouts_gen import BlinkyTimeouts
...
class BlinkyFileSystem(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyfilesystem').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.disk.file_system.blinky_file_system_gen import BlinkyFileSystem', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyfilesystem-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.disk.file_system.blinky_file_system_gen import BlinkyFileSystem', keyPathRegistered, keyPath, keyDepth)
    ...
    def setFileSystemTypeDefaultValue (self, setHas):
        ...
        self.myCandidateData.fileSystemType = FileSystemTypeType.kExt3
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_storage_disk.tech.storage.disk.file_system.file_system_data_gen import FileSystemData", 
        ...
        "logModuleName": "a-storage-disk-tech-storage-tech-storage-disk-file-system-blinky-file-system-gen", 
