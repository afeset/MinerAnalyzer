...
from a.api.yang.modules.tech.common.qwilt_tech_storage_disk.tech.storage.disk.system_defaults.file_system.commands.commands_data_gen import CommandsData
...
class BlinkyCommands(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkycommands').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.disk.system_defaults.file_system.commands.blinky_commands_gen import BlinkyCommands', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkycommands-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.disk.system_defaults.file_system.commands.blinky_commands_gen import BlinkyCommands', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_storage_disk.tech.storage.disk.system_defaults.file_system.commands.commands_data_gen import CommandsData", 
        ...
        "logModuleName": "a-storage-disk-tech-storage-tech-storage-disk-system-defaults-file-system-commands-blinky-commands-gen", 
