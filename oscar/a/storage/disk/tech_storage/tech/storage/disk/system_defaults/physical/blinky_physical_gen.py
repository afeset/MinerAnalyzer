...
from a.api.yang.modules.tech.common.qwilt_tech_storage_disk.tech.storage.disk.system_defaults.physical.physical_data_gen import PhysicalData
...
class BlinkyPhysical(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyphysical').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.disk.system_defaults.physical.blinky_physical_gen import BlinkyPhysical', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyphysical-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.disk.system_defaults.physical.blinky_physical_gen import BlinkyPhysical', keyPathRegistered, keyPath, keyDepth)
    ...
    def setImplementationDefaultValue (self, setHas):
        ...
        self.myCandidateData.implementation = DiskPhysicalImplementationType.kNone
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_storage_disk.tech.storage.disk.system_defaults.physical.physical_data_gen import PhysicalData", 
        ...
        "logModuleName": "a-storage-disk-tech-storage-tech-storage-disk-system-defaults-physical-blinky-physical-gen", 
