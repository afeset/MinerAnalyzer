...
from a.api.yang.modules.tech.common.qwilt_tech_storage_disk.tech.storage.disk.raid_array.raid_array_data_gen import RaidArrayData
...
class BlinkyRaidArray(BlinkyContainer):
    ...
    def trxElementUpdateCandidate(self, trxElement, keyDepth):
        ...
        elif (keyPath.isTagEqual(keyDepth, self.ourNamespace, self.ourXmlTagOsDevice)):
            if trxElement.getNewVal():
                newValue = trxElement.getNewVal()
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyraidarray').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.disk.raid_array.blinky_raid_array_gen import BlinkyRaidArray', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyraidarray-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.disk.raid_array.blinky_raid_array_gen import BlinkyRaidArray', keyPathRegistered, keyPath, keyDepth)
    ...
    def setImplementationDefaultValue (self, setHas):
        ...
        self.myCandidateData.implementation = RaidArrayImplementationType.kDirectory
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_storage_disk.tech.storage.disk.raid_array.raid_array_data_gen import RaidArrayData", 
        ...
        "logModuleName": "a-storage-disk-tech-storage-tech-storage-disk-raid-array-blinky-raid-array-gen", 
        "importStatement": "from a.storage.disk.tech_storage.tech.storage.disk.raid_array.blinky_raid_array_gen import BlinkyRaidArray", 
