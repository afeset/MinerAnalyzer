...
from a.api.yang.modules.tech.common.qwilt_tech_storage_module.tech.storage.module.status.status_oper_data_gen import StatusOperData
...
class BlinkyOperStatus(BlinkyOperNode):
    ...
    _kCallpointName = "tech-storage-module-status-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-storage-module-status-callpoint"
    ...
    def getOperRelativePath (self, operRelativePath):
        ...
        val = Value()
        val.setXmlTag(("status", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-storage-module", "qt-strg-module"))
    ...
    def setOperDataRequestedFields (self, operData, keyPath):
        ...
        if requestedKeyPath.isEqual(flattenedSelfKeyPath) or (requestedKeyPath.getLen() <= flattenedSelfKeyPath.getLen()):
            ...
            if requestedKeyPath.getLen() > flattenedSelfKeyPath.getLen():
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-storage-module", "location"):
    ...
    def fillTagValues (self, keyPath, tagValueList, operData):
        ...
        if operData.isLocationRequested() and operData.hasLocation():
            ...
            tagValueList.push(("location", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-storage-module"), val)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_storage_module.tech.storage.module.status.status_oper_data_gen import StatusOperData", 
        ...
        "logModuleName": "a-storage-disk-tech-storage-tech-storage-module-status-blinky-status-oper-gen", 
        "importStatement": "from a.storage.disk.tech_storage.tech.storage.module.status.blinky_status_oper_gen import BlinkyOperStatus", 
        "callpointName": "tech-storage-module-status-callpoint", 
