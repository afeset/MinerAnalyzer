...
from a.api.yang.modules.tech.common.qwilt_tech_storage_controller.tech.storage.controller.system_defaults.system_defaults_data_gen import SystemDefaultsData


from a.storage.disk.tech_storage.tech.storage.controller.system_defaults.timeouts.blinky_timeouts_gen import BlinkyTimeouts
...
class BlinkySystemDefaults(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkysystemdefaults').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.controller.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkysystemdefaults-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.controller.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults', keyPathRegistered, keyPath, keyDepth)
    ...
    def setImplementationDefaultValue (self, setHas):
        ...
        self.myCandidateData.implementation = StorageControllerImplementationType.kNone
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_storage_controller.tech.storage.controller.system_defaults.system_defaults_data_gen import SystemDefaultsData", 
        ...
        "logModuleName": "a-storage-disk-tech-storage-tech-storage-controller-system-defaults-blinky-system-defaults-gen", 
