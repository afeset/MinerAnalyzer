...
from a.api.yang.modules.tech.common.qwilt_tech_storage_controller.tech.storage.controller.timeouts.timeouts_data_gen import TimeoutsData
...
class BlinkyTimeouts(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkytimeouts').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.controller.timeouts.blinky_timeouts_gen import BlinkyTimeouts', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkytimeouts-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.storage.disk.tech_storage.tech.storage.controller.timeouts.blinky_timeouts_gen import BlinkyTimeouts', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_storage_controller.tech.storage.controller.timeouts.timeouts_data_gen import TimeoutsData", 
        ...
        "logModuleName": "a-storage-disk-tech-storage-tech-storage-controller-timeouts-blinky-timeouts-gen", 
