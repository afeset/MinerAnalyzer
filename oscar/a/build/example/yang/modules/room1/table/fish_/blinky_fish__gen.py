...
from a.build.example.yang.modules.room.table.fish_.fish__data_gen import FishData
...
class BlinkyFish(BlinkyContainer):
    ourNamespace="http://qwilt.com/model/room"
    #leaves
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyfish').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.build.example.yang.modules.room1.table.fish_.blinky_fish__gen import BlinkyFish', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyfish-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.build.example.yang.modules.room1.table.fish_.blinky_fish__gen import BlinkyFish', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.build.example.yang.modules.room.table.fish_.fish__data_gen import FishData", 
        ...
        "logModuleName": "a-build-example-yang-modules-room1-table-fish--blinky-fish--gen", 
        "importStatement": "from a.build.example.yang.modules.room1.table.fish_.blinky_fish__gen import BlinkyFish", 
