...
from a.build.example.yang.modules.room1.table.fish_.blinky_fish__gen import BlinkyFish
...
class BlinkyFishList(BlinkyList):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyfishlist').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am list of: from a.build.example.yang.modules.room1.table.fish_.blinky_fish__gen import BlinkyFish', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyfishlist-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am list of: from a.build.example.yang.modules.room1.table.fish_.blinky_fish__gen import BlinkyFish', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "fish_", 
        "containerImportStatement": "from a.build.example.yang.modules.room1.table.fish_.blinky_fish__gen import BlinkyFish", 
        "logGroupName": "blinky-fish-list", 
        "className": "BlinkyFishList", 
        "logModuleName": "a-build-example-yang-modules-room1-table-fish--blinky-fish--list-gen", 
        "keyLeaf": {
            "varName": "fish_", 
