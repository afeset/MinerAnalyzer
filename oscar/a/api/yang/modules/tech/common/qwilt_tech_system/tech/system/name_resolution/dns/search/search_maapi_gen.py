...
from search_maapi_base_gen import SearchMaapiBase




class BlinkySearchMaapi(SearchMaapiBase):
    ...
    def write (self
        ...
        return self._internalWrite(search, trxContext)
    ...
    def read (self
        ...
        return self._internalRead(search, 
                                  False,
                                  trxContext)
    ...
    def _getSelfKeyPath (self, search
    ...
    def _internalWrite (self, 
        ...
        itemsToDelete = []
        res = self._collectItemsToDelete(search, 
        ...
        keyPath = self._getSelfKeyPath(search, 
    ...
    def _fillWriteTagValues (self, tagValueList):
        ...
        if self.hasName():
            ...
            if self.name is not None:
                ...
                valName.setEmpty()
            tagValueList.push(("name", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system"), valName)
        ...
        if self.isNameRequested():
            ...
            if (tag != "name") or \
                ...
                for logFunc in self._log('reag-tag-values-unexpected-tag-leaf-name').errorFunc(): logFunc('got unexpected tag-value for leaf: %s. expected: (%s, %s), got: (%s, %s)',
                                                                                                 "name", "name", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system", tag, ns)
                self._clearAllReadData()
                return ReturnCodes.kGeneralError
...
Extracted from the below data: 
{
    "node": {
        "name": "search", 
        "namespace": "search", 
        "className": "SearchMaapi", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_system.tech.system.name_resolution.dns.search.search_maapi_gen import SearchMaapi", 
        "baseClassName": "SearchMaapiBase", 
        "baseModule": "search_maapi_base_gen"
    }, 
    "ancestors": [
        {
