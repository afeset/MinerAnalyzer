...
from server_maapi_base_gen import ServerMaapiBase


import struct


class BlinkyServerMaapi(ServerMaapiBase):
    ...
    def write (self
        ...
        return self._internalWrite(server, trxContext)
    ...
    def read (self
        ...
        return self._internalRead(server, 
                                  False,
                                  trxContext)
    ...
    def _getSelfKeyPath (self, server
    ...
    def _internalWrite (self, 
        ...
        itemsToDelete = []
        res = self._collectItemsToDelete(server, 
        ...
        keyPath = self._getSelfKeyPath(server, 
