...
from clock_maapi_base_gen import ClockMaapiBase

from a.api.yang.modules.tech.common.qwilt_tech_system_clock.tech.system.clock.status.status_maapi_gen import BlinkyStatusMaapi
from a.api.yang.modules.tech.common.qwilt_tech_system_clock.tech.system.clock.system_defaults.system_defaults_maapi_gen import BlinkySystemDefaultsMaapi



class BlinkyClockMaapi(ClockMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-clock")
        self.domain = None
    ...
    def _readTagValues (self, tagValueList, readAllOrFail):
        ...
        if self.statusObj:
            ...
            if (tag != "status") or \
                (ns != "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-clock") or \
                (valBegin.getType() != Value.kXmlBegin):
                for logFunc in self._log('reag-tag-values-unexpected-tag-begin').errorFunc(): logFunc('got unexpected tag-value. expected: (%s, %s, type=%s), got: (%s, %s, type=%s)',
                                                                        "status", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-clock", Value.kXmlBegin,
            ...
            if (tag != "status") or \
                ...
                for logFunc in self._log('reag-tag-values-unexpected-tag-end').errorFunc(): logFunc('got unexpected tag-value. expected: (%s, %s, type=%s), got: (%s, %s, type=%s)',
                                                                      "status", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-clock", Value.kXmlEnd,
        ...
        if self.systemDefaultsObj:
            ...
            if (tag != "system-defaults") or \
                ...
                (valBegin.getType() != Value.kXmlBegin):
                for logFunc in self._log('reag-tag-values-unexpected-tag-begin').errorFunc(): logFunc('got unexpected tag-value. expected: (%s, %s, type=%s), got: (%s, %s, type=%s)',
                                                                        "system-defaults", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-clock", Value.kXmlBegin,
                                                                        tag, ns, valBegin.getType())
                self._clearAllReadData()
                return ReturnCodes.kGeneralError
            ...
            if (tag != "system-defaults") or \
                ...
                (valEnd.getType() != Value.kXmlEnd):
                for logFunc in self._log('reag-tag-values-unexpected-tag-end').errorFunc(): logFunc('got unexpected tag-value. expected: (%s, %s, type=%s), got: (%s, %s, type=%s)',
                                                                      "system-defaults", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-clock", Value.kXmlEnd,
                                                                        tag, ns, valEnd.getType())
                self._clearAllReadData()
                return ReturnCodes.kGeneralError
...
Extracted from the below data: 
{
    "node": {
        "name": "clock", 
        "namespace": "clock", 
        "className": "ClockMaapi", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_system_clock.tech.system.clock.clock_maapi_gen import ClockMaapi", 
        "baseClassName": "ClockMaapiBase", 
        "baseModule": "clock_maapi_base_gen"
    }, 
    "ancestors": [
        {
    ...
    "descendants": [
        {
            ...
            "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_system_clock.tech.system.clock.status.status_maapi_gen import BlinkyStatusMaapi", 
            "isList": false, 
            "moduleYangNamespace": "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-clock"
        }, 
        {
            ...
            "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_system_clock.tech.system.clock.system_defaults.system_defaults_maapi_gen import BlinkySystemDefaultsMaapi", 
            "isList": false, 
            "moduleYangNamespace": "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-clock"
        }
    ], 
