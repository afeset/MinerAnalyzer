...
Extracted from the below data: 
{
    "node": {
        "className": "PingData", 
        "namespace": "ping", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.ping.ping_data_gen import PingData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
