...
class AnalyticsData(object):
    ...
    def __str__ (self):
        ...
        return "{AnalyticsData: "+",".join(items)+"}"
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "analytics", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.content.analytics.analytics_data_gen import AnalyticsData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
