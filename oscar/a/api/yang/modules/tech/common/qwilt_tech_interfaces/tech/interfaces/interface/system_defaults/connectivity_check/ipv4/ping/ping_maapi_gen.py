...
from ping_maapi_base_gen import PingMaapiBase




class BlinkyPingMaapi(PingMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-ping")
        self.domain = None
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "ping", 
        "className": "PingMaapi", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.ping.ping_maapi_gen import PingMaapi", 
        "baseClassName": "PingMaapiBase", 
        "baseModule": "ping_maapi_base_gen"
    }, 
    "ancestors": [
        {
