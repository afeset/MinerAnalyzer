...
from management_maapi_base_gen import ManagementMaapiBase




class BlinkyManagementMaapi(ManagementMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-management")
        self.domain = None
...
Extracted from the below data: 
{
    "node": {
        ...
        "className": "ManagementMaapi", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.management.management_maapi_gen import ManagementMaapi", 
        "baseClassName": "ManagementMaapiBase", 
        "baseModule": "management_maapi_base_gen"
    }, 
    "ancestors": [
        {
