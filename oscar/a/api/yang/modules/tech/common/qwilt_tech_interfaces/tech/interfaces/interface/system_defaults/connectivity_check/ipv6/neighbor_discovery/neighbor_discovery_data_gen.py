...
class NeighborDiscoveryData(object):
    ...
    def __str__ (self):
        ...
        return "{NeighborDiscoveryData: "+",".join(items)+"}"

"""
Extracted from the below data: 
{
    "node": {
        "className": "NeighborDiscoveryData", 
        "namespace": "neighbor_discovery", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.neighbor_discovery.neighbor_discovery_data_gen import NeighborDiscoveryData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
