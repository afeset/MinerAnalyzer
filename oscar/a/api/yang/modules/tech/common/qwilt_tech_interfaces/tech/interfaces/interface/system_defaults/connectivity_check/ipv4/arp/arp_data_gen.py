...
Extracted from the below data: 
{
    "node": {
        "className": "ArpData", 
        "namespace": "arp", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.arp.arp_data_gen import ArpData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
