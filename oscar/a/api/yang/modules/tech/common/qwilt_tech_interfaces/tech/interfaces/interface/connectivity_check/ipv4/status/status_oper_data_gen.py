...
class StatusOperData (object):
    ...
    def __init__ (self):
        ...
        self.actualMethod = ConnectivityCheckIpv4MethodType.kArp
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "status", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.connectivity_check.ipv4.status.status_oper_data_gen import StatusOperData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
