...
class ContinuousCountersOperData (object):
    ...
    def __str__ (self):
        ...
        return "{ContinuousCountersOperData: "+",".join(items)+"}"
...
{
    "node": {
        "className": "ContinuousCountersOperData", 
        "namespace": "continuous_counters", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.continuous_counters.continuous_counters_oper_data_gen import ContinuousCountersOperData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
