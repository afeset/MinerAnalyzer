...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.ipv6.address.address_maapi_list_gen import BlinkyAddressMaapiList
    ...
    def _fillWriteTagValues (self, tagValueList):
        ...
        if self.hasDefaultGateway():
            ...
            if self.defaultGateway is not None:
                valDefaultGateway.setIPv6(self.defaultGateway)
            else:
