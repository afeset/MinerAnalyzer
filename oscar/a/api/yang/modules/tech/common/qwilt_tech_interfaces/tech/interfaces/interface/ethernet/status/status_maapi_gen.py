...
class BlinkyStatusMaapi(StatusMaapiBase):
    ...
    def _fillReadTagValues (self, tagValueList):
        ...
        if self.isMacAddressRequested():
            ...
            tagValueList.push(("mac-address", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), valMacAddress)
        ...
        if self.isMacAddressRequested():
            ...
            if (tag != "mac-address") or \
                ...
                for logFunc in self._log('reag-tag-values-unexpected-tag-leaf-macaddress').errorFunc(): logFunc('got unexpected tag-value for leaf: %s. expected: (%s, %s), got: (%s, %s)',
                                                                                                 "macAddress", "mac-address", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", tag, ns)
                self._clearAllReadData()
                return ReturnCodes.kGeneralError
...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.ethernet.status.status_maapi_gen import StatusMaapi", 
