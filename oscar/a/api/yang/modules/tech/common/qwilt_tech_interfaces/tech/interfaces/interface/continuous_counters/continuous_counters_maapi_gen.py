...
from continuous_counters_maapi_base_gen import ContinuousCountersMaapiBase




class BlinkyContinuousCountersMaapi(ContinuousCountersMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-continuousCounters")
        self.domain = None
    ...
    def _getSelfKeyPath (self, interface
        ...
        xmlVal = Value()
        xmlVal.setXmlTag(("continuous-counters", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "qt-if"))
...
{
    "node": {
        "name": "continuousCounters", 
        "namespace": "continuous_counters", 
        "className": "ContinuousCountersMaapi", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.continuous_counters.continuous_counters_maapi_gen import ContinuousCountersMaapi", 
        "baseClassName": "ContinuousCountersMaapiBase", 
        "baseModule": "continuous_counters_maapi_base_gen"
    }, 
    "ancestors": [
        {
