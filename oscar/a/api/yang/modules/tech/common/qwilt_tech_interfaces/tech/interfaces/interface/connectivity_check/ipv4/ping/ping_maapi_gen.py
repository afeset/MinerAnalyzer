...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "ping", 
        "className": "PingMaapi", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.connectivity_check.ipv4.ping.ping_maapi_gen import PingMaapi", 
