...
from neighbor_discovery_maapi_base_gen import NeighborDiscoveryMaapiBase




class BlinkyNeighborDiscoveryMaapi(NeighborDiscoveryMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-neighborDiscovery")
        self.domain = None
...
Extracted from the below data: 
{
    "node": {
        ...
        "className": "NeighborDiscoveryMaapi", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.neighbor_discovery.neighbor_discovery_maapi_gen import NeighborDiscoveryMaapi", 
        "baseClassName": "NeighborDiscoveryMaapiBase", 
        "baseModule": "neighbor_discovery_maapi_base_gen"
    }, 
    "ancestors": [
        {
