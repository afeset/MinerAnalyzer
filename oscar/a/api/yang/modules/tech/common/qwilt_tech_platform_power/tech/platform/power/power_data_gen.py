...
Extracted from the below data: 
{
    "node": {
        "className": "PowerData", 
        "namespace": "power", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_data_gen import PowerData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
