...
class PowerSupplyData(object):
    ...
    def __str__ (self):
        ...
        return "{PowerSupplyData: "+",".join(items)+"}"

"""
Extracted from the below data: 
{
    "node": {
        "className": "PowerSupplyData", 
        "namespace": "power_supply", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_supply.power_supply_data_gen import PowerSupplyData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
