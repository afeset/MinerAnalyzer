...
class SimulationData(object):
    ...
    def __init__ (self):
        ...
        self.forceOperationalStatus = PowerSupplyForceOperationalStatusType.kDown
...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_supply.simulation.simulation_data_gen import SimulationData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
