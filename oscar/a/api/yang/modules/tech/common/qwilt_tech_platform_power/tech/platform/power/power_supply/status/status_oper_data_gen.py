...
class StatusOperData (object):
    ...
    def __init__ (self):
        ...
        self.operationalStatus = PowerSupplyOperationalStatusType.kDown
        self._myHasOperationalStatus=False
        self._myOperationalStatusRequested=False
        
        self.operationalStatusReason = PowerSupplyOperationalStatusReasonType.kNone
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "status", 
        "importStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_supply.status.status_oper_data_gen import StatusOperData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
