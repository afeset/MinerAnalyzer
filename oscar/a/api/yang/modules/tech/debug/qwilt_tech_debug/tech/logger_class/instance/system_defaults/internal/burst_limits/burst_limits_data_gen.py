...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.system_defaults.internal.burst_limits.burst_limits_data_gen import BurstLimitsData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
