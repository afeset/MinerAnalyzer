...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.internal.burst_limits.burst_limits_maapi_gen import BurstLimitsMaapi", 
