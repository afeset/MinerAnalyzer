...
class OutputData(object):
    ...
    def __init__ (self):
        ...
        self.archiveMode = LogArchiveModeType.kNone
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "output", 
        "importStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.destination.system_defaults.output.output_data_gen import OutputData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
