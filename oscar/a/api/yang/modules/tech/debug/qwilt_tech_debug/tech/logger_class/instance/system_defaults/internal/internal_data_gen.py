...
class InternalData(object):
    ...
    def __init__ (self):
        ...
        self.logMessageProcessing = LogSeverity.kNone
        self._myHasLogMessageProcessing=False
        
        self.logAction = LogSeverity.kNone
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "internal", 
        "importStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.system_defaults.internal.internal_data_gen import InternalData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
