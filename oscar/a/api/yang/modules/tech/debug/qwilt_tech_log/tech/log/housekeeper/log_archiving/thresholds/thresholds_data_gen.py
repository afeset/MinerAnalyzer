...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_log.tech.log.housekeeper.log_archiving.thresholds.thresholds_data_gen import ThresholdsData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
