...
from interfaces_maapi_base_gen import InterfacesMaapiBase

from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interface.interface_maapi_list_gen import BlinkyInterfaceMaapiList



class BlinkyInterfacesMaapi(InterfacesMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-interfaces")
        self.domain = None
    ...
    def _collectItemsToDelete (self,
        ...
        if self.interfaceListObj:
            res = self.interfaceListObj._collectItemsToDelete(
                                                                          itemsToDelete)
            if res != ReturnCodes.kOk:
