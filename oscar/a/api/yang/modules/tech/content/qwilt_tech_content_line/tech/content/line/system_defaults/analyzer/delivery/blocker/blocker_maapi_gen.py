...
from blocker_maapi_base_gen import BlockerMaapiBase




class BlinkyBlockerMaapi(BlockerMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-blocker")
        self.domain = None
    ...
    def _getSelfKeyPath (self, line
        ...
        xmlVal = Value()
        xmlVal.setXmlTag(("blocker", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-content-line", "qtc-line"))
...
Extracted from the below data: 
{
    "node": {
        "name": "blocker", 
        "namespace": "blocker", 
        "className": "BlockerMaapi", 
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.system_defaults.analyzer.delivery.blocker.blocker_maapi_gen import BlockerMaapi", 
        "baseClassName": "BlockerMaapiBase", 
        "baseModule": "blocker_maapi_base_gen"
    }, 
    "ancestors": [
        {
