...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.system_defaults.analyzer.house_keeper.sub_task_interval.sub_task_interval_data_gen import SubTaskIntervalData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
