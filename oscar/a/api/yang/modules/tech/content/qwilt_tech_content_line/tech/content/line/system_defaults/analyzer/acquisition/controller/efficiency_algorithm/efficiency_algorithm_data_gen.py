...
class EfficiencyAlgorithmData(object):
    ...
    def __init__ (self):
        ...
        self.onlyIfRangeOverlaps = DecisionType.kFalse
        self._myHasOnlyIfRangeOverlaps=False
        
        self.useContentItemSize = DecisionType.kFalse
        self._myHasUseContentItemSize=False
        
        self.thresholdPpm = 0
        self._myHasThresholdPpm=False
        
        self.continueOnceStarted = DecisionType.kFalse
...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.system_defaults.analyzer.acquisition.controller.efficiency_algorithm.efficiency_algorithm_data_gen import EfficiencyAlgorithmData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
