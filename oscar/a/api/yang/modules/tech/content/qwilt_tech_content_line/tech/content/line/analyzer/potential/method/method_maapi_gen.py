...
from method_maapi_base_gen import MethodMaapiBase

from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.analyzer.potential.method.system_defaults.system_defaults_maapi_gen import BlinkySystemDefaultsMaapi
...
class BlinkyMethodMaapi(MethodMaapiBase):
    def __init__ (self, logger):
        ...
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-method")
        self.domain = None
...
Extracted from the below data: 
{
    "node": {
        "name": "method", 
        "namespace": "method", 
        "className": "MethodMaapi", 
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.analyzer.potential.method.method_maapi_gen import MethodMaapi", 
        "baseClassName": "MethodMaapiBase", 
        "baseModule": "method_maapi_base_gen"
    }, 
    "ancestors": [
        {
    ...
    "descendants": [
        {
            ...
            "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.analyzer.potential.method.system_defaults.system_defaults_maapi_gen import BlinkySystemDefaultsMaapi", 
            "isList": false, 
            "moduleYangNamespace": "http://qwilt.com/ns/yang/device/tech/qwilt-tech-content-line"
        }
    ], 
