...
Extracted from the below data: 
{
    "node": {
        "className": "DpdkData", 
        "namespace": "dpdk", 
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.system_defaults.dispatcher.dpdk.dpdk_data_gen import DpdkData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
