...
from policy_maapi_base_gen import PolicyMaapiBase




class BlinkyPolicyMaapi(PolicyMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-policy")
        self.domain = None
    ...
    def _getSelfKeyPath (self, line
        ...
        xmlVal = Value()
        xmlVal.setXmlTag(("policy", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-content-line", "qtc-line"))
...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.system_defaults.analyzer.policy.policy_maapi_gen import PolicyMaapi", 
