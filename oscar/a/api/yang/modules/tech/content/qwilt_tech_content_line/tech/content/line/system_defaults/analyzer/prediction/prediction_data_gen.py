...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.system_defaults.analyzer.prediction.prediction_data_gen import PredictionData"
    }, 
    "ancestors": [
        {
            "namespace": "tech", 
