...
class PredictionMaapiBase(object):
    ...
    # estimatedDeliveryTrxPerConnection
...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.analyzer.prediction.prediction_maapi_gen import PredictionMaapi", 
