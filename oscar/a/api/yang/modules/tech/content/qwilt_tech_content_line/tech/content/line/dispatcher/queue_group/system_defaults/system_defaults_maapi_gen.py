...
class BlinkySystemDefaultsMaapi(SystemDefaultsMaapiBase):
    ...
    def write (self
        ...
        return self._internalWrite(line, queueGroup, trxContext)
...
Extracted from the below data: 
{
    "node": {
        ...
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.dispatcher.queue_group.system_defaults.system_defaults_maapi_gen import SystemDefaultsMaapi", 
