...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "ipc", 
        "className": "IpcMaapi", 
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.q_shell.ipc.ipc_maapi_gen import IpcMaapi", 
