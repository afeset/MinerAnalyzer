...
from vip_maapi_base_gen import VipMaapiBase




class BlinkyVipMaapi(VipMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-vip")
        self.domain = None
    ...
    def _getSelfKeyPath (self, line
        ...
        xmlVal = Value()
        xmlVal.setXmlTag(("vip", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-content-line", "qtc-line"))
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "vip", 
        "className": "VipMaapi", 
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_line.tech.content.line.analyzer.unit.vip.vip_maapi_gen import VipMaapi", 
