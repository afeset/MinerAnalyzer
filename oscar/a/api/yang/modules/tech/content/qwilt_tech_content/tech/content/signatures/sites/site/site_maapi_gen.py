...
class BlinkySiteMaapi(SiteMaapiBase):
    ...
    def write (self
        ...
        return self._internalWrite(site, trxContext)
    ...
    def read (self
        ...
        return self._internalRead(site, 
                                  False,
                                  trxContext)
    ...
    def _internalWrite (self, 
        ...
        itemsToDelete = []
        res = self._collectItemsToDelete(site, 
        ...
        keyPath = self._getSelfKeyPath(site, 
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "site", 
        "className": "SiteMaapi", 
        "importStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content.tech.content.signatures.sites.site.site_maapi_gen import SiteMaapi", 
