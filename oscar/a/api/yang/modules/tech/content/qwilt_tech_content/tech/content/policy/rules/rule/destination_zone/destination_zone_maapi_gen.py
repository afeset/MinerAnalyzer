...
from destination_zone_maapi_base_gen import DestinationZoneMaapiBase




class BlinkyDestinationZoneMaapi(DestinationZoneMaapiBase):
    ...
    def write (self
        ...
        return self._internalWrite(rule, destinationZone, trxContext)
    ...
    def read (self
        ...
        return self._internalRead(rule, destinationZone, 
                                  False,
                                  trxContext)
    ...
    def _getSelfKeyPath (self, rule
        ...
        ancestorVal = Value()
        ancestorVal.setString(destinationZone);
