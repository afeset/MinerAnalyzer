...
class BlinkyOperCounters(BlinkyOperNode):
    ...
    _kCallpointName = "tech-system-alarms-counters-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-system-alarms-counters-callpoint"
    ...
    def getOperRelativePath (self, operRelativePath):
        ...
        val = Value()
        val.setXmlTag(("counters", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "qt-sys-alarms"))
    ...
    def setOperDataRequestedFields (self, operData, keyPath):
        ...
        if requestedKeyPath.isEqual(flattenedSelfKeyPath) or (requestedKeyPath.getLen() <= flattenedSelfKeyPath.getLen()):
            ...
            if requestedKeyPath.getLen() > flattenedSelfKeyPath.getLen():
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "active-seconds"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "poll-latency-error"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "overall-poll-duration-warning"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "total-seconds"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "polls"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "missed-polls"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "single-poll-duration-warning"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "single-poll-duration-error"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "alarms-created"):
                    for logFunc in self._log("set-oper-data-requested-fields-alarmscreated-requested").debug3Func(): logFunc(
                        "alarms-created requested. requestedKeyPath=%s, operData=%s", requestedKeyPath, operData.debugStr(True))
                    operData.setAlarmsCreatedRequested()
                
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "poll-latency-warning"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "overall-poll-duration-error"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "poll-errors"):
                    for logFunc in self._log("set-oper-data-requested-fields-pollerrors-requested").debug3Func(): logFunc(
                        "poll-errors requested. requestedKeyPath=%s, operData=%s", requestedKeyPath, operData.debugStr(True))
                    operData.setPollErrorsRequested()
    ...
    def fillTagValues (self, keyPath, tagValueList, operData):
        ...
        if operData.isActiveSecondsRequested() and operData.hasActiveSeconds():
            ...
            tagValueList.push(("active-seconds", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        
        if operData.isPollLatencyErrorRequested() and operData.hasPollLatencyError():
            val = Value()
            val.setInt64(operData.pollLatencyError)
            tagValueList.push(("poll-latency-error", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        ...
        if operData.isOverallPollDurationWarningRequested() and operData.hasOverallPollDurationWarning():
            ...
            tagValueList.push(("overall-poll-duration-warning", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        
        if operData.isTotalSecondsRequested() and operData.hasTotalSeconds():
            val = Value()
            val.setInt64(operData.totalSeconds)
            tagValueList.push(("total-seconds", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        
        if operData.isPollsRequested() and operData.hasPolls():
            val = Value()
            val.setInt64(operData.polls)
            tagValueList.push(("polls", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        
        if operData.isMissedPollsRequested() and operData.hasMissedPolls():
            val = Value()
            val.setInt64(operData.missedPolls)
            tagValueList.push(("missed-polls", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        ...
        if operData.isSinglePollDurationWarningRequested() and operData.hasSinglePollDurationWarning():
            ...
            tagValueList.push(("single-poll-duration-warning", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        ...
        if operData.isSinglePollDurationErrorRequested() and operData.hasSinglePollDurationError():
            ...
            tagValueList.push(("single-poll-duration-error", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        
        if operData.isAlarmsCreatedRequested() and operData.hasAlarmsCreated():
            val = Value()
            val.setInt64(operData.alarmsCreated)
            tagValueList.push(("alarms-created", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        
        if operData.isPollLatencyWarningRequested() and operData.hasPollLatencyWarning():
            val = Value()
            val.setInt64(operData.pollLatencyWarning)
            tagValueList.push(("poll-latency-warning", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        ...
        if operData.isOverallPollDurationErrorRequested() and operData.hasOverallPollDurationError():
            ...
            tagValueList.push(("overall-poll-duration-error", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
        
        if operData.isPollErrorsRequested() and operData.hasPollErrors():
            val = Value()
            val.setInt64(operData.pollErrors)
            tagValueList.push(("poll-errors", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms"), val)
    ...
    def fillValue (self, value, keyPath, operData):
        ...
        if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "alarms-created"):
            if operData.isAlarmsCreatedRequested():
                 if operData.hasAlarmsCreated():
                     value.setInt64(operData.alarmsCreated)
                 else:
                     value.setEmpty()
        ...
        if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-system-alarms", "poll-errors"):
            if operData.isPollErrorsRequested():
                 if operData.hasPollErrors():
                     value.setInt64(operData.pollErrors)
                 else:
                     value.setEmpty()
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_system_alarms.tech.system.alarms.counters.counters_oper_data_gen import CountersOperData", 
        ...
        "logModuleName": "a-sys-mng-alarm-tech-system-alarms-tech-system-alarms-counters-blinky-counters-oper-gen", 
        "importStatement": "from a.sys.mng.alarm.tech_system_alarms.tech.system.alarms.counters.blinky_counters_oper_gen import BlinkyOperCounters", 
        "callpointName": "tech-system-alarms-counters-callpoint", 
