...
class BlinkyThresholds(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkythresholds').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.mng.alarm.tech_system_alarms.tech.system.alarms.thresholds.blinky_thresholds_gen import BlinkyThresholds', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkythresholds-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.mng.alarm.tech_system_alarms.tech.system.alarms.thresholds.blinky_thresholds_gen import BlinkyThresholds', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_system_alarms.tech.system.alarms.thresholds.thresholds_data_gen import ThresholdsData", 
        ...
        "logModuleName": "a-sys-mng-alarm-tech-system-alarms-tech-system-alarms-thresholds-blinky-thresholds-gen", 
