...
from a.api.yang.modules.tech.common.qwilt_tech_snmp.tech.snmp.snmp_oper_data_gen import SnmpOperData
...
class BlinkyOperSnmp(BlinkyOperNode):

    _kCallpointName = "tech-snmp-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-snmp-callpoint"
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_snmp.tech.snmp.snmp_oper_data_gen import SnmpOperData", 
        ...
        "yangName": "snmp", 
        "namespace": "snmp", 
        "logGroupName": "blinky-snmp-oper", 
        "className": "BlinkyOperSnmp", 
        "logModuleName": "a-sys-snmp-tech-snmp-manager-tech-snmp-blinky-snmp-oper-gen", 
        "importStatement": "from a.sys.snmp.tech_snmp_manager.tech.snmp.blinky_snmp_oper_gen import BlinkyOperSnmp", 
        "callpointName": "tech-snmp-callpoint", 
        "moduleYangNamespace": "http://qwilt.com/ns/yang/device/tech/qwilt-tech-snmp", 
        "dataClassName": "SnmpOperData", 
        "getObjArgsNum": 2, 
