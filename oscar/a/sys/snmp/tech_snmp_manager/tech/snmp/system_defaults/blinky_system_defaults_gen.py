...
from a.api.yang.modules.tech.common.qwilt_tech_snmp.tech.snmp.system_defaults.system_defaults_data_gen import SystemDefaultsData
...
class BlinkySystemDefaults(BlinkyContainer):
    ...
    def s_create (cls, logger, 
        ...
        xmlVal = Value()
        xmlVal.setXmlTag(("system-defaults", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-snmp", "qt-snmp"))
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkysystemdefaults').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.snmp.tech_snmp_manager.tech.snmp.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkysystemdefaults-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.snmp.tech_snmp_manager.tech.snmp.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_snmp.tech.snmp.system_defaults.system_defaults_data_gen import SystemDefaultsData", 
        ...
        "logModuleName": "a-sys-snmp-tech-snmp-manager-tech-snmp-system-defaults-blinky-system-defaults-gen", 
