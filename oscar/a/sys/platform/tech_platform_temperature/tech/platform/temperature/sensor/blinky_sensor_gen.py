...
from a.api.yang.modules.tech.common.qwilt_tech_platform_temperature.tech.platform.temperature.sensor.sensor_data_gen import SensorData


from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.simulation.blinky_simulation_gen import BlinkySimulation

from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults

from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.device.blinky_device_gen import BlinkyDevice




class BlinkySensor(BlinkyContainer):
    ...
    def s_create (cls, logger, 
        ...
        logger('s-create-blinkysensor').info('called. domain=%s, _validationPointId=%s, _actionPointId=%s', domain, BlinkySensor._validationPointId, BlinkySensor._actionPointId)
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkysensor').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.blinky_sensor_gen import BlinkySensor', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkysensor-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.blinky_sensor_gen import BlinkySensor', keyPathRegistered, keyPath, keyDepth)
    ...
    def allocMyCandidate(self):
        for logFunc in self._log("alloc-my-candidate").debug3Func():
            logFunc("called")
        self.myCandidateData = SensorData()
        ...
        if progress.isCommitBlinkyBefore() or progress.isAbortBlinkyBefore():
            if self.isInDestroy:
                if self._validationPointId and self.validateRegistrationDone:
                    ...
                    if (res != ReturnCodes.kOk):
                        for logFunc in self._log("handle-trx-progress-notification-specitic-unregister-validation-point-blinkysensor-failed").errorFunc():
                ...
                if self._actionPointId and self.actionRegistrationDone:
                    ...
                    if (res != ReturnCodes.kOk):
                        for logFunc in self._log("handle-trx-progress-notification-specitic-unregister-action-point-blinkysensor-failed").errorFunc():
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_temperature.tech.platform.temperature.sensor.sensor_data_gen import SensorData", 
        "moduleYangNamespacePrefix": "qt-pltf-temperature", 
        "validationPoint": null, 
        "yangName": "sensor", 
        "namespace": "sensor", 
        "logGroupName": "blinky-sensor", 
        "className": "BlinkySensor", 
        "logModuleName": "a-sys-platform-tech-platform-temperature-tech-platform-temperature-sensor-blinky-sensor-gen", 
        "importStatement": "from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.blinky_sensor_gen import BlinkySensor", 
    ...
    "descendants": [
        ...
        }, 
        {
            ...
            "importStatement": "from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults"
        }, 
        {
            "className": "BlinkyDevice", 
            "memberName": "Device", 
            "yangName": "device", 
            "importStatement": "from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.device.blinky_device_gen import BlinkyDevice"
        }
    ], 
