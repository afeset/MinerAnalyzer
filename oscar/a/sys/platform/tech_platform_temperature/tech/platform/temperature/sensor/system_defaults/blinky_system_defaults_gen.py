...
from a.api.yang.modules.tech.common.qwilt_tech_platform_temperature.tech.platform.temperature.sensor.system_defaults.system_defaults_data_gen import SystemDefaultsData


from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.system_defaults.device.blinky_device_gen import BlinkyDevice

from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.system_defaults.simulation.blinky_simulation_gen import BlinkySimulation
...
class BlinkySystemDefaults(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkysystemdefaults').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults', keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_temperature.tech.platform.temperature.sensor.system_defaults.system_defaults_data_gen import SystemDefaultsData", 
        ...
        "logModuleName": "a-sys-platform-tech-platform-temperature-tech-platform-temperature-sensor-system-defaults-blinky-system-defaults-gen", 
    ...
    "descendants": [
        {
            ...
            "memberName": "Device", 
            "yangName": "device", 
            "importStatement": "from a.sys.platform.tech_platform_temperature.tech.platform.temperature.sensor.system_defaults.device.blinky_device_gen import BlinkyDevice"
        }, 
        {
