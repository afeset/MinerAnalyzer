...
from a.api.yang.modules.tech.common.qwilt_tech_platform_temperature.tech.platform.temperature.system_defaults.simulation.simulation_data_gen import SimulationData
...
class BlinkySimulation(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkysimulation').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_temperature.tech.platform.temperature.system_defaults.simulation.blinky_simulation_gen import BlinkySimulation', keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_temperature.tech.platform.temperature.system_defaults.simulation.simulation_data_gen import SimulationData", 
        ...
        "logModuleName": "a-sys-platform-tech-platform-temperature-tech-platform-temperature-system-defaults-simulation-blinky-simulation-gen", 
