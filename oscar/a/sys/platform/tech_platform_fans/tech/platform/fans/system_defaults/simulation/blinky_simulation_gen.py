...
from a.api.yang.modules.tech.common.qwilt_tech_platform_fans.tech.platform.fans.system_defaults.simulation.simulation_data_gen import SimulationData
...
class BlinkySimulation(BlinkyContainer):
    ...
    def trxElementUpdateCandidate(self, trxElement, keyDepth):
        ...
        if (keyPath.isTagEqual(keyDepth, self.ourNamespace, self.ourXmlTagForceOperationalStatus)):
            if trxElement.getNewVal():
                ...
                if not FansForceOperationalStatusType.isValidValue(newValue.asEnum()):
                ...
                self.myCandidateData.forceOperationalStatus = FansForceOperationalStatusType.getByValue(newValue.asEnum())
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkysimulation').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_fans.tech.platform.fans.system_defaults.simulation.blinky_simulation_gen import BlinkySimulation', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkysimulation-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_fans.tech.platform.fans.system_defaults.simulation.blinky_simulation_gen import BlinkySimulation', keyPathRegistered, keyPath, keyDepth)
    ...
    def setForceOperationalStatusDefaultValue (self, setHas):
        ...
        self.myCandidateData.forceOperationalStatus = FansForceOperationalStatusType.kNone
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_fans.tech.platform.fans.system_defaults.simulation.simulation_data_gen import SimulationData", 
        ...
        "logModuleName": "a-sys-platform-tech-platform-fans-tech-platform-fans-system-defaults-simulation-blinky-simulation-gen", 
        "importStatement": "from a.sys.platform.tech_platform_fans.tech.platform.fans.system_defaults.simulation.blinky_simulation_gen import BlinkySimulation", 
