...
from a.api.yang.modules.tech.common.qwilt_tech_platform_fans.tech.platform.fans.fan.device.device_data_gen import DeviceData
...
class BlinkyDevice(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkydevice').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_fans.tech.platform.fans.fan.device.blinky_device_gen import BlinkyDevice', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkydevice-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_fans.tech.platform.fans.fan.device.blinky_device_gen import BlinkyDevice', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_fans.tech.platform.fans.fan.device.device_data_gen import DeviceData", 
        ...
        "logModuleName": "a-sys-platform-tech-platform-fans-tech-platform-fans-fan-device-blinky-device-gen", 
