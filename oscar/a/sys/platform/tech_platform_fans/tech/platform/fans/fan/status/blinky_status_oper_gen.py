...
from a.api.yang.modules.tech.common.qwilt_tech_platform_fans.tech.platform.fans.fan.status.status_oper_data_gen import StatusOperData
...
class BlinkyOperStatus(BlinkyOperNode):
    ...
    _kCallpointName = "tech-platform-fans-fan-status-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-platform-fans-fan-status-callpoint"
    ...
    def setOperDataRequestedFields (self, operData, keyPath):
        ...
        if requestedKeyPath.isEqual(flattenedSelfKeyPath) or (requestedKeyPath.getLen() <= flattenedSelfKeyPath.getLen()):
            ...
            if requestedKeyPath.getLen() > flattenedSelfKeyPath.getLen():
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-fans", "location"):
    ...
    def fillTagValues (self, keyPath, tagValueList, operData):
        ...
        if operData.isLocationRequested() and operData.hasLocation():
            ...
            tagValueList.push(("location", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-fans"), val)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_fans.tech.platform.fans.fan.status.status_oper_data_gen import StatusOperData", 
        ...
        "logModuleName": "a-sys-platform-tech-platform-fans-tech-platform-fans-fan-status-blinky-status-oper-gen", 
        "importStatement": "from a.sys.platform.tech_platform_fans.tech.platform.fans.fan.status.blinky_status_oper_gen import BlinkyOperStatus", 
        "callpointName": "tech-platform-fans-fan-status-callpoint", 
