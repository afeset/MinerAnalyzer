...
from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.status.status_oper_data_gen import StatusOperData
...
class BlinkyOperStatus(BlinkyOperNode):
    ...
    _kCallpointName = "tech-platform-power-status-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-platform-power-status-callpoint"
    ...
    def setOperDataRequestedFields (self, operData, keyPath):
        ...
        if requestedKeyPath.isEqual(flattenedSelfKeyPath) or (requestedKeyPath.getLen() <= flattenedSelfKeyPath.getLen()):
            ...
            if requestedKeyPath.getLen() > flattenedSelfKeyPath.getLen():
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power", "redundancy-status-raw"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power", "operational-status"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power", "redundancy-status"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power", "operational-status-reason"):
    ...
    def fillTagValues (self, keyPath, tagValueList, operData):
        ...
        if operData.isRedundancyStatusRawRequested() and operData.hasRedundancyStatusRaw():
            ...
            tagValueList.push(("redundancy-status-raw", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power"), val)
        ...
        if operData.isRedundancyStatusRequested() and operData.hasRedundancyStatus():
            ...
            tagValueList.push(("redundancy-status", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power"), val)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.status.status_oper_data_gen import StatusOperData", 
        ...
        "logModuleName": "a-sys-platform-tech-platform-power-tech-platform-power-status-blinky-status-oper-gen", 
        "importStatement": "from a.sys.platform.tech_platform_power.tech.platform.power.status.blinky_status_oper_gen import BlinkyOperStatus", 
        "callpointName": "tech-platform-power-status-callpoint", 
