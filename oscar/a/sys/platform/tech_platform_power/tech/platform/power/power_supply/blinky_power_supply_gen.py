...
from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_supply.power_supply_data_gen import PowerSupplyData


from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.simulation.blinky_simulation_gen import BlinkySimulation

from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults

from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.device.blinky_device_gen import BlinkyDevice




class BlinkyPowerSupply(BlinkyContainer):
    ...
    def s_create (cls, logger, 
        ...
        logger('s-create-blinkypowersupply').info('called. domain=%s, _validationPointId=%s, _actionPointId=%s', domain, BlinkyPowerSupply._validationPointId, BlinkyPowerSupply._actionPointId)
        ...
        newNode=BlinkyPowerSupply(logger)
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkypowersupply').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.blinky_power_supply_gen import BlinkyPowerSupply', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkypowersupply-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.blinky_power_supply_gen import BlinkyPowerSupply', keyPathRegistered, keyPath, keyDepth)
    ...
    def allocMyCandidate(self):
        for logFunc in self._log("alloc-my-candidate").debug3Func():
            logFunc("called")
        self.myCandidateData = PowerSupplyData()
    ...
    def activateCandidate(self):
        ...
        if (self.myState.isPhaseDone(phase)):
            ...
            return
        self.myRunningData = PowerSupplyData()
        ...
        if progress.isCommitBlinkyBefore() or progress.isAbortBlinkyBefore():
            if self.isInDestroy:
                if self._validationPointId and self.validateRegistrationDone:
                    ...
                    if (res != ReturnCodes.kOk):
                        for logFunc in self._log("handle-trx-progress-notification-specitic-unregister-validation-point-blinkypowersupply-failed").errorFunc():
                ...
                if self._actionPointId and self.actionRegistrationDone:
                    ...
                    if (res != ReturnCodes.kOk):
                        for logFunc in self._log("handle-trx-progress-notification-specitic-unregister-action-point-blinkypowersupply-failed").errorFunc():
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_supply.power_supply_data_gen import PowerSupplyData", 
        "moduleYangNamespacePrefix": "qt-pltf-pwr", 
        "validationPoint": null, 
        "yangName": "power-supply", 
        "namespace": "power_supply", 
        "logGroupName": "blinky-power-supply", 
        "className": "BlinkyPowerSupply", 
        "logModuleName": "a-sys-platform-tech-platform-power-tech-platform-power-power-supply-blinky-power-supply-gen", 
        "importStatement": "from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.blinky_power_supply_gen import BlinkyPowerSupply", 
        "moduleYangNamespace": "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power", 
        "dataClassName": "PowerSupplyData", 
        "actionPoint": null
    }, 
    "ancestors": [
        {
    ...
    "descendants": [
        ...
        }, 
        {
            ...
            "importStatement": "from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults"
        }, 
        {
            "className": "BlinkyDevice", 
            "memberName": "Device", 
            "yangName": "device", 
            "importStatement": "from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.device.blinky_device_gen import BlinkyDevice"
        }
    ], 
