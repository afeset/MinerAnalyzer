...
from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_supply.simulation.simulation_data_gen import SimulationData
...
class BlinkySimulation(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkysimulation').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.simulation.blinky_simulation_gen import BlinkySimulation', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkysimulation-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.simulation.blinky_simulation_gen import BlinkySimulation', keyPathRegistered, keyPath, keyDepth)
    ...
    def setForceOperationalStatusDefaultValue (self, setHas):
        ...
        self.myCandidateData.forceOperationalStatus = PowerSupplyForceOperationalStatusType.kDown
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_supply.simulation.simulation_data_gen import SimulationData", 
        ...
        "logModuleName": "a-sys-platform-tech-platform-power-tech-platform-power-power-supply-simulation-blinky-simulation-gen", 
        "importStatement": "from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.simulation.blinky_simulation_gen import BlinkySimulation", 
