...
from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_supply.status.status_oper_data_gen import StatusOperData
...
class BlinkyOperStatus(BlinkyOperNode):
    ...
    _kCallpointName = "tech-platform-power-power-supply-status-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-platform-power-power-supply-status-callpoint"
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.power_supply.status.status_oper_data_gen import StatusOperData", 
        ...
        "logModuleName": "a-sys-platform-tech-platform-power-tech-platform-power-power-supply-status-blinky-status-oper-gen", 
        "importStatement": "from a.sys.platform.tech_platform_power.tech.platform.power.power_supply.status.blinky_status_oper_gen import BlinkyOperStatus", 
        "callpointName": "tech-platform-power-power-supply-status-callpoint", 
