...
from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.alarm.alarm_oper_data_gen import AlarmOperData
...
class BlinkyOperAlarm(BlinkyOperNode):
    ...
    _kCallpointName = "tech-platform-power-alarm-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-platform-power-alarm-callpoint"
    ...
    def setOperDataRequestedFields (self, operData, keyPath):
        ...
        if requestedKeyPath.isEqual(flattenedSelfKeyPath) or (requestedKeyPath.getLen() <= flattenedSelfKeyPath.getLen()):
            ...
            if requestedKeyPath.getLen() > flattenedSelfKeyPath.getLen():
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power", "no-redundancy-reason"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power", "no-redundancy"):
    ...
    def fillTagValues (self, keyPath, tagValueList, operData):
        ...
        if operData.isNoRedundancyReasonRequested() and operData.hasNoRedundancyReason():
            ...
            tagValueList.push(("no-redundancy-reason", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power"), val)
        
        if operData.isNoRedundancyRequested() and operData.hasNoRedundancy():
            val = Value()
            val.setBool(operData.noRedundancy)
            tagValueList.push(("no-redundancy", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-platform-power"), val)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_platform_power.tech.platform.power.alarm.alarm_oper_data_gen import AlarmOperData", 
        ...
        "logModuleName": "a-sys-platform-tech-platform-power-tech-platform-power-alarm-blinky-alarm-oper-gen", 
        "importStatement": "from a.sys.platform.tech_platform_power.tech.platform.power.alarm.blinky_alarm_oper_gen import BlinkyOperAlarm", 
        "callpointName": "tech-platform-power-alarm-callpoint", 
