...
from a.api.yang.modules.tech.debug.qwilt_tech_log.tech.log.system_defaults.housekeeper.thresholds.thresholds_data_gen import ThresholdsData
...
class BlinkyThresholds(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkythresholds').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.log.housekeeper.blinky.tech.log.system_defaults.housekeeper.thresholds.blinky_thresholds_gen import BlinkyThresholds', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkythresholds-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.log.housekeeper.blinky.tech.log.system_defaults.housekeeper.thresholds.blinky_thresholds_gen import BlinkyThresholds', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_log.tech.log.system_defaults.housekeeper.thresholds.thresholds_data_gen import ThresholdsData", 
        ...
        "logModuleName": "a-sys-log-housekeeper-blinky-tech-log-system-defaults-housekeeper-thresholds-blinky-thresholds-gen", 
