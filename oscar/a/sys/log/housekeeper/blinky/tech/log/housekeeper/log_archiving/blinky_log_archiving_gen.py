...
from a.api.yang.modules.tech.debug.qwilt_tech_log.tech.log.housekeeper.log_archiving.log_archiving_data_gen import LogArchivingData


from a.sys.log.housekeeper.blinky.tech.log.housekeeper.log_archiving.thresholds.blinky_thresholds_gen import BlinkyThresholds
...
class BlinkyLogArchiving(BlinkyContainer):
    ...
    _actionPointId=None
    _actionPointId="tech-log-housekeeper-log-archiving-clear-counters-actionpoint"
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkylogarchiving').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.log.housekeeper.blinky.tech.log.housekeeper.log_archiving.blinky_log_archiving_gen import BlinkyLogArchiving', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkylogarchiving-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.log.housekeeper.blinky.tech.log.housekeeper.log_archiving.blinky_log_archiving_gen import BlinkyLogArchiving', keyPathRegistered, keyPath, keyDepth)
    ...
    def setDummyDefaultValue (self, setHas):
        ...
        self.myCandidateData.dummy = False
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_log.tech.log.housekeeper.log_archiving.log_archiving_data_gen import LogArchivingData", 
        ...
        "logModuleName": "a-sys-log-housekeeper-blinky-tech-log-housekeeper-log-archiving-blinky-log-archiving-gen", 
        "importStatement": "from a.sys.log.housekeeper.blinky.tech.log.housekeeper.log_archiving.blinky_log_archiving_gen import BlinkyLogArchiving", 
        "moduleYangNamespace": "http://qwilt.com/ns/yang/device/tech/qwilt-tech-log", 
        "dataClassName": "LogArchivingData", 
        "actionPoint": "tech-log-housekeeper-log-archiving-clear-counters-actionpoint"
    }, 
    "ancestors": [
        {
    ...
    "descendants": [
        {
            ...
            "yangName": "thresholds", 
            "importStatement": "from a.sys.log.housekeeper.blinky.tech.log.housekeeper.log_archiving.thresholds.blinky_thresholds_gen import BlinkyThresholds"
        }
    ], 
