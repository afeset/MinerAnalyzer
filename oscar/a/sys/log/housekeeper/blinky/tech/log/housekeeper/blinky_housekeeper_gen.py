...
from a.api.yang.modules.tech.debug.qwilt_tech_log.tech.log.housekeeper.housekeeper_data_gen import HousekeeperData


from a.sys.log.housekeeper.blinky.tech.log.housekeeper.thresholds.blinky_thresholds_gen import BlinkyThresholds

from a.sys.log.housekeeper.blinky.tech.log.housekeeper.log_archiving.blinky_log_archiving_gen import BlinkyLogArchiving
...
class BlinkyHousekeeper(BlinkyContainer):
    ...
    _actionPointId=None
    _actionPointId="tech-log-housekeeper-clear-counters-actionpoint"
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyhousekeeper').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.log.housekeeper.blinky.tech.log.housekeeper.blinky_housekeeper_gen import BlinkyHousekeeper', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyhousekeeper-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.log.housekeeper.blinky.tech.log.housekeeper.blinky_housekeeper_gen import BlinkyHousekeeper', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_log.tech.log.housekeeper.housekeeper_data_gen import HousekeeperData", 
        ...
        "logModuleName": "a-sys-log-housekeeper-blinky-tech-log-housekeeper-blinky-housekeeper-gen", 
        ...
        "actionPoint": "tech-log-housekeeper-clear-counters-actionpoint"
    }, 
    "ancestors": [
        {
