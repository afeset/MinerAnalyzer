...
from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.destination.system_defaults.format.format_data_gen import FormatData
...
class BlinkyFormat(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyformat').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.log.blinky.manager.tech.logger_class.instance.destination.system_defaults.format.blinky_format_gen import BlinkyFormat', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyformat-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.log.blinky.manager.tech.logger_class.instance.destination.system_defaults.format.blinky_format_gen import BlinkyFormat', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.destination.system_defaults.format.format_data_gen import FormatData", 
        ...
        "logModuleName": "a-sys-log-blinky-manager-tech-logger-class-instance-destination-system-defaults-format-blinky-format-gen", 
