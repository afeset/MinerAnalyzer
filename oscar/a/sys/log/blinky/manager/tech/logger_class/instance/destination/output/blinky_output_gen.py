...
from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.destination.output.output_data_gen import OutputData
...
class BlinkyOutput(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyoutput').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.log.blinky.manager.tech.logger_class.instance.destination.output.blinky_output_gen import BlinkyOutput', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyoutput-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.log.blinky.manager.tech.logger_class.instance.destination.output.blinky_output_gen import BlinkyOutput', keyPathRegistered, keyPath, keyDepth)
    ...
    def setArchiveModeDefaultValue (self, setHas):
        ...
        self.myCandidateData.archiveMode = LogArchiveModeType.kNoCompression
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.destination.output.output_data_gen import OutputData", 
        ...
        "logModuleName": "a-sys-log-blinky-manager-tech-logger-class-instance-destination-output-blinky-output-gen", 
