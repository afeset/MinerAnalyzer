...
from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.internal.burst_limits.burst_limits_data_gen import BurstLimitsData
...
class BlinkyBurstLimits(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyburstlimits').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.log.blinky.manager.tech.logger_class.instance.internal.burst_limits.blinky_burst_limits_gen import BlinkyBurstLimits', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyburstlimits-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.log.blinky.manager.tech.logger_class.instance.internal.burst_limits.blinky_burst_limits_gen import BlinkyBurstLimits', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.internal.burst_limits.burst_limits_data_gen import BurstLimitsData", 
        ...
        "logModuleName": "a-sys-log-blinky-manager-tech-logger-class-instance-internal-burst-limits-blinky-burst-limits-gen", 
