...
from a.sys.log.blinky.manager.tech.logger_class.instance.destination.blinky_destination_gen import BlinkyDestination
...
class BlinkyDestinationList(BlinkyList):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkydestinationlist').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am list of: from a.sys.log.blinky.manager.tech.logger_class.instance.destination.blinky_destination_gen import BlinkyDestination', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkydestinationlist-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am list of: from a.sys.log.blinky.manager.tech.logger_class.instance.destination.blinky_destination_gen import BlinkyDestination', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "containerImportStatement": "from a.sys.log.blinky.manager.tech.logger_class.instance.destination.blinky_destination_gen import BlinkyDestination", 
        "logGroupName": "blinky-destination-list", 
        "className": "BlinkyDestinationList", 
        "logModuleName": "a-sys-log-blinky-manager-tech-logger-class-instance-destination-blinky-destination-list-gen", 
        "keyLeaf": {
            "varName": "destination", 
