...
from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.internal.internal_data_gen import InternalData


from a.sys.log.blinky.manager.tech.logger_class.instance.internal.burst_limits.blinky_burst_limits_gen import BlinkyBurstLimits
...
class BlinkyInternal(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyinternal').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.log.blinky.manager.tech.logger_class.instance.internal.blinky_internal_gen import BlinkyInternal', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyinternal-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.log.blinky.manager.tech.logger_class.instance.internal.blinky_internal_gen import BlinkyInternal', keyPathRegistered, keyPath, keyDepth)
    ...
    def setLogMessageProcessingDefaultValue (self, setHas):
        ...
        self.myCandidateData.logMessageProcessing = LogSeverity.kDebug1
    ...
    def setLogActionDefaultValue (self, setHas):
        ...
        self.myCandidateData.logAction = LogSeverity.kDebug1
    ...
    def setLogMessageCreationDefaultValue (self, setHas):
        ...
        self.myCandidateData.logMessageCreation = LogSeverity.kDebug1
    ...
    def setLogConfigurationDefaultValue (self, setHas):
        ...
        self.myCandidateData.logConfiguration = LogSeverity.kDebug1
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.debug.qwilt_tech_debug.tech.logger_class.instance.internal.internal_data_gen import InternalData", 
        ...
        "logModuleName": "a-sys-log-blinky-manager-tech-logger-class-instance-internal-blinky-internal-gen", 
    ...
    "descendants": [
        {
            ...
            "importStatement": "from a.sys.log.blinky.manager.tech.logger_class.instance.internal.burst_limits.blinky_burst_limits_gen import BlinkyBurstLimits"
        }
    ], 
