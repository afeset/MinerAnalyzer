...
from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.antenna.blinky_antenna_gen import BlinkyAntenna

from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.test_generation_underscore.blinky_test_generation_underscore_list_gen import BlinkyTestGenerationUnderscoreList

from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.transparent_container.blinky_transparent_container_gen import BlinkyTransparentContainer
...
class BlinkyFish(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyfish').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.blinky_fish__gen import BlinkyFish', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyfish-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.blinky_fish__gen import BlinkyFish', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "logModuleName": "a-sys-blinky-example-lake-example-no-stop-generation-lake-fish--blinky-fish--gen", 
        "importStatement": "from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.blinky_fish__gen import BlinkyFish", 
    ...
    "descendants": [
        ...
        }, 
        {
            ...
            "importStatement": "from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.test_generation_underscore.blinky_test_generation_underscore_list_gen import BlinkyTestGenerationUnderscoreList"
        }, 
        {
