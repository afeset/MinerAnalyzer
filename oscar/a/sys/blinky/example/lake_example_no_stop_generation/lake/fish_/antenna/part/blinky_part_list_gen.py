...
from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.antenna.part.blinky_part_gen import BlinkyPart
...
class BlinkyPartList(BlinkyList):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkypartlist').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am list of: from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.antenna.part.blinky_part_gen import BlinkyPart', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkypartlist-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am list of: from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.antenna.part.blinky_part_gen import BlinkyPart', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "part", 
        "containerImportStatement": "from a.sys.blinky.example.lake_example_no_stop_generation.lake.fish_.antenna.part.blinky_part_gen import BlinkyPart", 
        "logGroupName": "blinky-part-list", 
        "className": "BlinkyPartList", 
        "logModuleName": "a-sys-blinky-example-lake-example-no-stop-generation-lake-fish--antenna-part-blinky-part-list-gen", 
        "keyLeaf": {
            "varName": "part", 
