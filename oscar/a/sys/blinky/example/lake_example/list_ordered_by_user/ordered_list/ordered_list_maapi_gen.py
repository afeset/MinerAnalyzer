...
from ordered_list_maapi_base_gen import OrderedListMaapiBase




class BlinkyOrderedListMaapi(OrderedListMaapiBase):
    ...
    def write (self
        ...
        return self._internalWrite(orderedList, trxContext)
    ...
    def read (self
        ...
        return self._internalRead(orderedList, 
                                  False,
                                  trxContext)
    ...
    def _getSelfKeyPath (self, orderedList
    ...
    def _internalWrite (self, 
        ...
        itemsToDelete = []
        res = self._collectItemsToDelete(orderedList, 
        ...
        keyPath = self._getSelfKeyPath(orderedList, 
