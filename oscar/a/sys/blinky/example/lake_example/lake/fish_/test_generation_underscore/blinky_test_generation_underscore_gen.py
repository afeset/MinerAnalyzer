...
class BlinkyTestGenerationUnderscore(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkytestgenerationunderscore').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.lake_example.lake.fish_.test_generation_underscore.blinky_test_generation_underscore_gen import BlinkyTestGenerationUnderscore', keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "logModuleName": "a-sys-blinky-example-lake-example-lake-fish--test-generation-underscore-blinky-test-generation-underscore-gen", 
        "importStatement": "from a.sys.blinky.example.lake_example.lake.fish_.test_generation_underscore.blinky_test_generation_underscore_gen import BlinkyTestGenerationUnderscore", 
