...
from a.sys.blinky.example.lake_example.lake.fish_.antenna.part.blinky_part_list_gen import BlinkyPartList
...
class BlinkyAntenna(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyantenna').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.lake_example.lake.fish_.antenna.blinky_antenna_gen import BlinkyAntenna', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyantenna-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.lake_example.lake.fish_.antenna.blinky_antenna_gen import BlinkyAntenna', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "logModuleName": "a-sys-blinky-example-lake-example-lake-fish--antenna-blinky-antenna-gen", 
    ...
    "descendants": [
        {
            ...
            "memberName": "PartList", 
            "yangName": "parts", 
            "importStatement": "from a.sys.blinky.example.lake_example.lake.fish_.antenna.part.blinky_part_list_gen import BlinkyPartList"
        }
    ], 
