...
class BlinkyTransparentContainer(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkytransparentcontainer').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.lake_example.lake.fish_.transparent_container.blinky_transparent_container_gen import BlinkyTransparentContainer', keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "logModuleName": "a-sys-blinky-example-lake-example-lake-fish--transparent-container-blinky-transparent-container-gen", 
