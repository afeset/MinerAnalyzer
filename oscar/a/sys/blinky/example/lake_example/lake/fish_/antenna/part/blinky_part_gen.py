...
class BlinkyPart(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkypart').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.lake_example.lake.fish_.antenna.part.blinky_part_gen import BlinkyPart', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkypart-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.lake_example.lake.fish_.antenna.part.blinky_part_gen import BlinkyPart', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "logModuleName": "a-sys-blinky-example-lake-example-lake-fish--antenna-part-blinky-part-gen", 
        "importStatement": "from a.sys.blinky.example.lake_example.lake.fish_.antenna.part.blinky_part_gen import BlinkyPart", 
