...
from a.sys.blinky.example.lake_example.lake.fish_.test_generation_underscore.blinky_test_generation_underscore_gen import BlinkyTestGenerationUnderscore
...
class BlinkyTestGenerationUnderscoreList(BlinkyList):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkytestgenerationunderscorelist').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am list of: from a.sys.blinky.example.lake_example.lake.fish_.test_generation_underscore.blinky_test_generation_underscore_gen import BlinkyTestGenerationUnderscore', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkytestgenerationunderscorelist-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am list of: from a.sys.blinky.example.lake_example.lake.fish_.test_generation_underscore.blinky_test_generation_underscore_gen import BlinkyTestGenerationUnderscore', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "containerImportStatement": "from a.sys.blinky.example.lake_example.lake.fish_.test_generation_underscore.blinky_test_generation_underscore_gen import BlinkyTestGenerationUnderscore", 
        "logGroupName": "blinky-test-generation-underscore-list", 
        "className": "BlinkyTestGenerationUnderscoreList", 
        "logModuleName": "a-sys-blinky-example-lake-example-lake-fish--test-generation-underscore-blinky-test-generation-underscore-list-gen", 
        "keyLeaf": {
