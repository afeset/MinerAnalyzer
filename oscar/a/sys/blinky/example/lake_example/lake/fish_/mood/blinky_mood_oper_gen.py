...
Extracted from the below data: 
{
    "node": {
        ...
        "logModuleName": "a-sys-blinky-example-lake-example-lake-fish--mood-blinky-mood-oper-gen", 
        "importStatement": "from a.sys.blinky.example.lake_example.lake.fish_.mood.blinky_mood_oper_gen import BlinkyOperMood", 
