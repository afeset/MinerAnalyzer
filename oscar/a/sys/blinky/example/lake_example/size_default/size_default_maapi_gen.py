...
from size_default_maapi_base_gen import SizeDefaultMaapiBase




class BlinkySizeDefaultMaapi(SizeDefaultMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-sizeDefault")
        self.domain = None
