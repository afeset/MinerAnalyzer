...
class SomeListData(object):
    ...
    def __str__ (self):
        ...
        return "{SomeListData: "+",".join(items)+"}"

"""
Extracted from the below data: 
{
    "node": {
        "className": "SomeListData", 
        "namespace": "some_list", 
        "importStatement": "from a.sys.blinky.example.lake_example.ref_practice.some_list.some_list_data_gen import SomeListData"
    }, 
    "ancestors": [
        {
