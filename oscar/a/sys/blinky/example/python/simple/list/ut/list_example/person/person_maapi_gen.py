...
class BlinkyPersonMaapi(PersonMaapiBase):
    ...
    def _fillWriteTagValues (self, tagValueList):
        ...
        if self.hasEmployed():
            ...
            tagValueList.push(("employed", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/list-example"), valEmployed)
        ...
        if self.hasName():
            ...
            if self.name is not None:
                ...
                valName.setEmpty()
            tagValueList.push(("name", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/list-example"), valName)
        ...
        if self.hasHeight():
            ...
            if self.height is not None:
                ...
                valHeight.setEmpty()
            tagValueList.push(("height", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/list-example"), valHeight)
        ...
        if self.isEmployedRequested():
            ...
            if (tag != "employed") or \
                ...
                for logFunc in self._log('reag-tag-values-unexpected-tag-leaf-employed').errorFunc(): logFunc('got unexpected tag-value for leaf: %s. expected: (%s, %s), got: (%s, %s)',
                                                                                                 "employed", "employed", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/list-example", tag, ns)
                self._clearAllReadData()
                return ReturnCodes.kGeneralError
        ...
        if self.isNameRequested():
            ...
            if (tag != "name") or \
                ...
                for logFunc in self._log('reag-tag-values-unexpected-tag-leaf-name').errorFunc(): logFunc('got unexpected tag-value for leaf: %s. expected: (%s, %s), got: (%s, %s)',
                                                                                                 "name", "name", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/list-example", tag, ns)
                self._clearAllReadData()
                return ReturnCodes.kGeneralError
        ...
        if self.isHeightRequested():
            ...
            if (tag != "height") or \
                ...
                for logFunc in self._log('reag-tag-values-unexpected-tag-leaf-height').errorFunc(): logFunc('got unexpected tag-value for leaf: %s. expected: (%s, %s), got: (%s, %s)',
                                                                                                 "height", "height", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/list-example", tag, ns)
                self._clearAllReadData()
                return ReturnCodes.kGeneralError
