...
from a.sys.blinky.example.python.simple.list.ut.list_example.person.person_data_gen import PersonData
...
class BlinkyPerson(BlinkyContainer):
    ourNamespace="http://qwilt.com/ns/yang/ut/sys/blinky/example/python/list-example"
    #leaves
    ...
    def trxElementUpdateCandidate(self, trxElement, keyDepth):
        ...
        if (keyPath.isTagEqual(keyDepth, self.ourNamespace, self.ourXmlTagEmployed)):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyperson').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.python.simple.list.ut.list_example.person.blinky_person_gen import BlinkyPerson', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyperson-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.python.simple.list.ut.list_example.person.blinky_person_gen import BlinkyPerson', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.sys.blinky.example.python.simple.list.ut.list_example.person.person_data_gen import PersonData", 
        ...
        "logModuleName": "a-sys-blinky-example-python-simple-list-ut-list-example-person-blinky-person-gen", 
        "importStatement": "from a.sys.blinky.example.python.simple.list.ut.list_example.person.blinky_person_gen import BlinkyPerson", 
