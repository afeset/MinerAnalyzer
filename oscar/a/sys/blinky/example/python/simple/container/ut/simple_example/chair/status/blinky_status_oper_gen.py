...
from a.sys.blinky.example.python.simple.container.ut.simple_example.chair.status.status_oper_data_gen import StatusOperData
...
class BlinkyOperStatus(BlinkyOperNode):
    ...
    _kCallpointName = "chair-status-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "chair-status-callpoint"
    ...
    def getOperRelativePath (self, operRelativePath):
        ...
        val = Value()
        val.setXmlTag(("status", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/simple-example", "se"))
    ...
    def setOperDataRequestedFields (self, operData, keyPath):
        ...
        if requestedKeyPath.isEqual(flattenedSelfKeyPath) or (requestedKeyPath.getLen() <= flattenedSelfKeyPath.getLen()):
            ...
            if requestedKeyPath.getLen() > flattenedSelfKeyPath.getLen():
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/simple-example", "version"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/simple-example", "health"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/simple-example", "num-of-cracks"):
    ...
    def fillTagValues (self, keyPath, tagValueList, operData):
        ...
        if operData.isVersionRequested() and operData.hasVersion():
            ...
            tagValueList.push(("version", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/simple-example"), val)
        
        if operData.isHealthRequested() and operData.hasHealth():
            val = Value()
            val.setString(operData.health)
            tagValueList.push(("health", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/simple-example"), val)
        
        if operData.isNumOfCracksRequested() and operData.hasNumOfCracks():
            val = Value()
            val.setInt64(operData.numOfCracks)
            tagValueList.push(("num-of-cracks", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/simple-example"), val)
...
{
    "node": {
        "dataImportStatement": "from a.sys.blinky.example.python.simple.container.ut.simple_example.chair.status.status_oper_data_gen import StatusOperData", 
        ...
        "logModuleName": "a-sys-blinky-example-python-simple-container-ut-simple-example-chair-status-blinky-status-oper-gen", 
        "importStatement": "from a.sys.blinky.example.python.simple.container.ut.simple_example.chair.status.blinky_status_oper_gen import BlinkyOperStatus", 
        "callpointName": "chair-status-callpoint", 
