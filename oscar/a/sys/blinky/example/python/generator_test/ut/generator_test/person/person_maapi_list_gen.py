...
class BlinkyPersonMaapiList(PersonMaapiListBase):
    ...
    def _fillWriteTagValues (self, tagValueList):
        ...
        for key in self.persons.keys():
            if self.persons[key]:
                valBegin = Value()
                (tag, ns, prefix) = ("people", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/generator-test", "le")
                valBegin.setXmlBegin((tag, ns, prefix))
                tagValueList.push((tag, ns), valBegin)

                valKey = Value()
                valKey.setString(key)
                tagValueList.push(("name", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/generator-test"), valKey)
            ...
            if self.persons[key]:
                ...
                if (tag != "people") or \
                    ...
                    for logFunc in self._log('reag-tag-values-unexpected-tag-begin').errorFunc(): logFunc('got unexpected tag-value. expected: (%s, %s, type=%s), got: (%s, %s, type=%s)',
                                                                            "people", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/generator-test", Value.kXmlBegin,
                ...
                if (tag != "name") or \
                    ...
                    for logFunc in self._log('reag-tag-values-unexpected-tag-key').errorFunc(): logFunc('got unexpected tag-value for key. expected: (%s, %s), got: (%s, %s)',
                                                                          "name", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/generator-test", tag, ns)
                    self._clearAllReadData()
                    return ReturnCodes.kGeneralError
                ...
                if (tag != "people") or \
                    ...
                    for logFunc in self._log('reag-tag-values-unexpected-tag-end').errorFunc(): logFunc('got unexpected tag-value. expected: (%s, %s, type=%s), got: (%s, %s, type=%s)',
                                                                          "people", "http://qwilt.com/ns/yang/ut/sys/blinky/example/python/generator-test", Value.kXmlEnd,
