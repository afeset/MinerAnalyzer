...
from a.sys.blinky.example.ut.school_example.school.person.person_data_gen import PersonData
...
class BlinkyPerson(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyperson').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.ut.sche.school.person.blinky_person_gen import BlinkyPerson', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyperson-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.blinky.example.ut.sche.school.person.blinky_person_gen import BlinkyPerson', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.sys.blinky.example.ut.school_example.school.person.person_data_gen import PersonData", 
        ...
        "logModuleName": "a-sys-blinky-example-ut-sche-school-person-blinky-person-gen", 
        "importStatement": "from a.sys.blinky.example.ut.sche.school.person.blinky_person_gen import BlinkyPerson", 
