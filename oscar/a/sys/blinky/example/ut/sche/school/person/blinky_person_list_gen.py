...
from a.sys.blinky.example.ut.sche.school.person.blinky_person_gen import BlinkyPerson
...
class BlinkyPersonList(BlinkyList):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkypersonlist').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am list of: from a.sys.blinky.example.ut.sche.school.person.blinky_person_gen import BlinkyPerson', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkypersonlist-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am list of: from a.sys.blinky.example.ut.sche.school.person.blinky_person_gen import BlinkyPerson', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "person", 
        "containerImportStatement": "from a.sys.blinky.example.ut.sche.school.person.blinky_person_gen import BlinkyPerson", 
        "logGroupName": "blinky-person-list", 
        "className": "BlinkyPersonList", 
        "logModuleName": "a-sys-blinky-example-ut-sche-school-person-blinky-person-list-gen", 
        "keyLeaf": {
            "varName": "person", 
