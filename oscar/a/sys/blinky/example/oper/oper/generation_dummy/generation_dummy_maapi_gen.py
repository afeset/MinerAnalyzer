...
from generation_dummy_maapi_base_gen import GenerationDummyMaapiBase




class BlinkyGenerationDummyMaapi(GenerationDummyMaapiBase):
    def __init__ (self, logger):
        self.myInitGuard = InitGuard()
        self._log=logger.createLogger("sys-blinky-oper-example","blinky-maapi-generationDummy")
        self.domain = None
    ...
    def _fillWriteTagValues (self, tagValueList):
        ...
        if self.hasDummy():
            ...
            if self.dummy is not None:
                ...
                valDummy.setEmpty()
            tagValueList.push(("dummy", "http://qwilt.com/model/oper"), valDummy)
        ...
        if self.isDummyRequested():
            ...
            if (tag != "dummy") or \
                ...
                for logFunc in self._log('reag-tag-values-unexpected-tag-leaf-dummy').errorFunc(): logFunc('got unexpected tag-value for leaf: %s. expected: (%s, %s), got: (%s, %s)',
                                                                                                 "dummy", "dummy", "http://qwilt.com/model/oper", tag, ns)
                self._clearAllReadData()
                return ReturnCodes.kGeneralError
