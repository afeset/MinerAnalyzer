...
from a.sys.net.tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.application_initiated_discovery.blinky_application_initiated_discovery_gen import BlinkyApplicationInitiatedDiscovery
...
class BlinkyNeighbors(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyneighbors').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.blinky_neighbors_gen import BlinkyNeighbors', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyneighbors-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.blinky_neighbors_gen import BlinkyNeighbors', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.neighbors_data_gen import NeighborsData", 
        ...
        "logModuleName": "a-sys-net-tech-network-ipv6-tech-network-ipv6-system-defaults-neighbors-blinky-neighbors-gen", 
        "importStatement": "from a.sys.net.tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.blinky_neighbors_gen import BlinkyNeighbors", 
    ...
    "descendants": [
        {
            ...
            "importStatement": "from a.sys.net.tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.application_initiated_discovery.blinky_application_initiated_discovery_gen import BlinkyApplicationInitiatedDiscovery"
        }
    ], 
