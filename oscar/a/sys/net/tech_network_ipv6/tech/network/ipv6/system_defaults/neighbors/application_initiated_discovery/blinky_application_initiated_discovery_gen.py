...
from a.api.yang.modules.tech.common.qwilt_tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.application_initiated_discovery.application_initiated_discovery_data_gen import ApplicationInitiatedDiscoveryData
...
class BlinkyApplicationInitiatedDiscovery(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyapplicationinitiateddiscovery').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.application_initiated_discovery.blinky_application_initiated_discovery_gen import BlinkyApplicationInitiatedDiscovery', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyapplicationinitiateddiscovery-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.application_initiated_discovery.blinky_application_initiated_discovery_gen import BlinkyApplicationInitiatedDiscovery', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_network_ipv6.tech.network.ipv6.system_defaults.neighbors.application_initiated_discovery.application_initiated_discovery_data_gen import ApplicationInitiatedDiscoveryData", 
        ...
        "logModuleName": "a-sys-net-tech-network-ipv6-tech-network-ipv6-system-defaults-neighbors-application-initiated-discovery-blinky-application-initiated-discovery-gen", 
