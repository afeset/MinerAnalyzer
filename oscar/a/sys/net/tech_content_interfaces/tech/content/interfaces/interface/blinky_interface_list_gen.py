...
from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.blinky_interface_gen import BlinkyInterface
...
class BlinkyInterfaceList(BlinkyList):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyinterfacelist').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am list of: from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.blinky_interface_gen import BlinkyInterface', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyinterfacelist-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am list of: from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.blinky_interface_gen import BlinkyInterface', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "interface", 
        "containerImportStatement": "from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.blinky_interface_gen import BlinkyInterface", 
        "logGroupName": "blinky-interface-list", 
        "className": "BlinkyInterfaceList", 
        "logModuleName": "a-sys-net-tech-content-interfaces-tech-content-interfaces-interface-blinky-interface-list-gen", 
        "keyLeaf": {
            "varName": "interface", 
