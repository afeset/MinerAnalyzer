...
from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interface.delivery.ipv6.ipv6_data_gen import Ipv6Data
...
class BlinkyIpv6(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyipv6').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.delivery.ipv6.blinky_ipv6_gen import BlinkyIpv6', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyipv6-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.delivery.ipv6.blinky_ipv6_gen import BlinkyIpv6', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interface.delivery.ipv6.ipv6_data_gen import Ipv6Data", 
        ...
        "logModuleName": "a-sys-net-tech-content-interfaces-tech-content-interfaces-interface-delivery-ipv6-blinky-ipv6-gen", 
