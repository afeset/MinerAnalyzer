...
from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interface.delivery.ipv4.status.status_oper_data_gen import StatusOperData
...
class BlinkyOperStatus(BlinkyOperNode):
    ...
    _kCallpointName = "tech-content-interfaces-interface-delivery-ipv4-status-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-content-interfaces-interface-delivery-ipv4-status-callpoint"
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interface.delivery.ipv4.status.status_oper_data_gen import StatusOperData", 
        ...
        "logModuleName": "a-sys-net-tech-content-interfaces-tech-content-interfaces-interface-delivery-ipv4-status-blinky-status-oper-gen", 
        "importStatement": "from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.delivery.ipv4.status.blinky_status_oper_gen import BlinkyOperStatus", 
        "callpointName": "tech-content-interfaces-interface-delivery-ipv4-status-callpoint", 
