...
from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interface.system_defaults.delivery.delivery_data_gen import DeliveryData
...
class BlinkyDelivery(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkydelivery').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.system_defaults.delivery.blinky_delivery_gen import BlinkyDelivery', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkydelivery-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.system_defaults.delivery.blinky_delivery_gen import BlinkyDelivery', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interface.system_defaults.delivery.delivery_data_gen import DeliveryData", 
        ...
        "logModuleName": "a-sys-net-tech-content-interfaces-tech-content-interfaces-interface-system-defaults-delivery-blinky-delivery-gen", 
