...
from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.blinky_interface_list_gen import BlinkyInterfaceList
...
class BlinkyInterfaces(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyinterfaces').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_content_interfaces.tech.content.interfaces.blinky_interfaces_gen import BlinkyInterfaces', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyinterfaces-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_content_interfaces.tech.content.interfaces.blinky_interfaces_gen import BlinkyInterfaces', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interfaces_data_gen import InterfacesData", 
        ...
        "logModuleName": "a-sys-net-tech-content-interfaces-tech-content-interfaces-blinky-interfaces-gen", 
        "importStatement": "from a.sys.net.tech_content_interfaces.tech.content.interfaces.blinky_interfaces_gen import BlinkyInterfaces", 
    ...
    "descendants": [
        {
            ...
            "yangName": "interface", 
            "importStatement": "from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.blinky_interface_list_gen import BlinkyInterfaceList"
        }
    ], 
