...
from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interface.interface_data_gen import InterfaceData


from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.delivery.blinky_delivery_gen import BlinkyDelivery

from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults
...
class BlinkyInterface(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyinterface').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.blinky_interface_gen import BlinkyInterface', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyinterface-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.blinky_interface_gen import BlinkyInterface', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.content.qwilt_tech_content_interfaces.tech.content.interfaces.interface.interface_data_gen import InterfaceData", 
        ...
        "logModuleName": "a-sys-net-tech-content-interfaces-tech-content-interfaces-interface-blinky-interface-gen", 
        "importStatement": "from a.sys.net.tech_content_interfaces.tech.content.interfaces.interface.blinky_interface_gen import BlinkyInterface", 
