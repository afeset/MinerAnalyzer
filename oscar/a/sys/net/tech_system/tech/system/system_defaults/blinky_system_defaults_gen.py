...
from a.api.yang.modules.tech.common.qwilt_tech_system.tech.system.system_defaults.system_defaults_data_gen import SystemDefaultsData


from a.sys.net.tech_system.tech.system.system_defaults.name_resolution.blinky_name_resolution_gen import BlinkyNameResolution
...
class BlinkySystemDefaults(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkysystemdefaults').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_system.tech.system.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkysystemdefaults-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_system.tech.system.system_defaults.blinky_system_defaults_gen import BlinkySystemDefaults', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_system.tech.system.system_defaults.system_defaults_data_gen import SystemDefaultsData", 
        ...
        "logModuleName": "a-sys-net-tech-system-tech-system-system-defaults-blinky-system-defaults-gen", 
    ...
    "descendants": [
        {
            ...
            "importStatement": "from a.sys.net.tech_system.tech.system.system_defaults.name_resolution.blinky_name_resolution_gen import BlinkyNameResolution"
        }
    ], 
