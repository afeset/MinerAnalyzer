...
from a.api.yang.modules.tech.common.qwilt_tech_system.tech.system.system_defaults.name_resolution.dns.dns_data_gen import DnsData
...
class BlinkyDns(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkydns').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_system.tech.system.system_defaults.name_resolution.dns.blinky_dns_gen import BlinkyDns', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkydns-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_system.tech.system.system_defaults.name_resolution.dns.blinky_dns_gen import BlinkyDns', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_system.tech.system.system_defaults.name_resolution.dns.dns_data_gen import DnsData", 
        ...
        "className": "BlinkyDns", 
        "logModuleName": "a-sys-net-tech-system-tech-system-system-defaults-name-resolution-dns-blinky-dns-gen", 
        "importStatement": "from a.sys.net.tech_system.tech.system.system_defaults.name_resolution.dns.blinky_dns_gen import BlinkyDns", 
