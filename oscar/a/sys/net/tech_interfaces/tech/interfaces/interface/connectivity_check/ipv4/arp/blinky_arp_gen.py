...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.connectivity_check.ipv4.arp.arp_data_gen import ArpData
...
class BlinkyArp(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyarp').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.connectivity_check.ipv4.arp.blinky_arp_gen import BlinkyArp', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyarp-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.connectivity_check.ipv4.arp.blinky_arp_gen import BlinkyArp', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.connectivity_check.ipv4.arp.arp_data_gen import ArpData", 
        ...
        "className": "BlinkyArp", 
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-connectivity-check-ipv4-arp-blinky-arp-gen", 
