...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.ping.ping_data_gen import PingData





class BlinkyPing(BlinkyContainer):
    ...
    def s_create (cls, logger, 
        ...
        logger('s-create-blinkyping').info('called. domain=%s, _validationPointId=%s, _actionPointId=%s', domain, BlinkyPing._validationPointId, BlinkyPing._actionPointId)

        confd_key=KeyPath()
        
        
        xmlVal = Value()
        xmlVal.setXmlTag(("ping", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "qt-if"))
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyping').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.ping.blinky_ping_gen import BlinkyPing', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyping-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.ping.blinky_ping_gen import BlinkyPing', keyPathRegistered, keyPath, keyDepth)
    ...
    def setTestTimeoutMsecDefaultValue (self, setHas):
        ...
        self.myCandidateData.testTimeoutMsec = 500
    ...
    def setTestIntervalMsecDefaultValue (self, setHas):
        ...
        self.myCandidateData.testIntervalMsec = 1000
    ...
    def setUpPeriodDefaultValue (self, setHas):
        ...
        self.myCandidateData.upPeriod = 10
    ...
    def setDownPeriodDefaultValue (self, setHas):
        ...
        self.myCandidateData.downPeriod = 5
        ...
        if progress.isCommitBlinkyBefore() or progress.isAbortBlinkyBefore():
            if self.isInDestroy:
                if self._validationPointId and self.validateRegistrationDone:
                    ...
                    if (res != ReturnCodes.kOk):
                        for logFunc in self._log("handle-trx-progress-notification-specitic-unregister-validation-point-blinkyping-failed").errorFunc():
                ...
                if self._actionPointId and self.actionRegistrationDone:
                    ...
                    if (res != ReturnCodes.kOk):
                        for logFunc in self._log("handle-trx-progress-notification-specitic-unregister-action-point-blinkyping-failed").errorFunc():
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.ping.ping_data_gen import PingData", 
        "moduleYangNamespacePrefix": "qt-if", 
        "validationPoint": null, 
        "yangName": "ping", 
        "namespace": "ping", 
        "logGroupName": "blinky-ping", 
        "className": "BlinkyPing", 
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-system-defaults-connectivity-check-ipv4-ping-blinky-ping-gen", 
        "importStatement": "from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.ping.blinky_ping_gen import BlinkyPing", 
        "moduleYangNamespace": "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", 
        "dataClassName": "PingData", 
        "actionPoint": null
    }, 
    "ancestors": [
        {
