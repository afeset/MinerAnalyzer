...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.neighbor_discovery.neighbor_discovery_data_gen import NeighborDiscoveryData
...
class BlinkyNeighborDiscovery(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyneighbordiscovery').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.neighbor_discovery.blinky_neighbor_discovery_gen import BlinkyNeighborDiscovery', keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.neighbor_discovery.neighbor_discovery_data_gen import NeighborDiscoveryData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-system-defaults-connectivity-check-ipv6-neighbor-discovery-blinky-neighbor-discovery-gen", 
