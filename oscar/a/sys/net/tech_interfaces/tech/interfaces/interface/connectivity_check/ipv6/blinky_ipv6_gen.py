...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.connectivity_check.ipv6.ipv6_data_gen import Ipv6Data


from a.sys.net.tech_interfaces.tech.interfaces.interface.connectivity_check.ipv6.neighbor_discovery.blinky_neighbor_discovery_gen import BlinkyNeighborDiscovery

from a.sys.net.tech_interfaces.tech.interfaces.interface.connectivity_check.ipv6.ping.blinky_ping_gen import BlinkyPing
...
class BlinkyIpv6(BlinkyContainer):
    ...
    _actionPointId=None
    _actionPointId="tech-interfaces-interface-connectivity-check-ipv6-clear-counters-actionpoint"
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyipv6').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.connectivity_check.ipv6.blinky_ipv6_gen import BlinkyIpv6', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyipv6-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.connectivity_check.ipv6.blinky_ipv6_gen import BlinkyIpv6', keyPathRegistered, keyPath, keyDepth)
    ...
    def setMethodDefaultValue (self, setHas):
        ...
        self.myCandidateData.method = ConnectivityCheckIpv6MethodType.kPing
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.connectivity_check.ipv6.ipv6_data_gen import Ipv6Data", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-connectivity-check-ipv6-blinky-ipv6-gen", 
        ...
        "actionPoint": "tech-interfaces-interface-connectivity-check-ipv6-clear-counters-actionpoint"
    }, 
    "ancestors": [
        {
