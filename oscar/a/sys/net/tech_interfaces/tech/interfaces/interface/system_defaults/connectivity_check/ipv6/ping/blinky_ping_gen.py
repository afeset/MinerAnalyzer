...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.ping.ping_data_gen import PingData
...
class BlinkyPing(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyping').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.ping.blinky_ping_gen import BlinkyPing', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyping-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.ping.blinky_ping_gen import BlinkyPing', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv6.ping.ping_data_gen import PingData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-system-defaults-connectivity-check-ipv6-ping-blinky-ping-gen", 
