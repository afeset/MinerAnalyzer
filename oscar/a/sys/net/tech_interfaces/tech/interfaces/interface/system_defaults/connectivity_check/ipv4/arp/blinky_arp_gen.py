...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.arp.arp_data_gen import ArpData





class BlinkyArp(BlinkyContainer):
    ...
    def s_create (cls, logger, 
        ...
        logger('s-create-blinkyarp').info('called. domain=%s, _validationPointId=%s, _actionPointId=%s', domain, BlinkyArp._validationPointId, BlinkyArp._actionPointId)
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyarp').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.arp.blinky_arp_gen import BlinkyArp', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyarp-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.arp.blinky_arp_gen import BlinkyArp', keyPathRegistered, keyPath, keyDepth)
        ...
        if progress.isCommitBlinkyBefore() or progress.isAbortBlinkyBefore():
            if self.isInDestroy:
                if self._validationPointId and self.validateRegistrationDone:
                    ...
                    if (res != ReturnCodes.kOk):
                        for logFunc in self._log("handle-trx-progress-notification-specitic-unregister-validation-point-blinkyarp-failed").errorFunc():
                ...
                if self._actionPointId and self.actionRegistrationDone:
                    ...
                    if (res != ReturnCodes.kOk):
                        for logFunc in self._log("handle-trx-progress-notification-specitic-unregister-action-point-blinkyarp-failed").errorFunc():
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.arp.arp_data_gen import ArpData", 
        "moduleYangNamespacePrefix": "qt-if", 
        "validationPoint": null, 
        "yangName": "arp", 
        "namespace": "arp", 
        "logGroupName": "blinky-arp", 
        "className": "BlinkyArp", 
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-system-defaults-connectivity-check-ipv4-arp-blinky-arp-gen", 
        "importStatement": "from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.connectivity_check.ipv4.arp.blinky_arp_gen import BlinkyArp", 
        "moduleYangNamespace": "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", 
        "dataClassName": "ArpData", 
        "actionPoint": null
    }, 
    "ancestors": [
        {
