...
from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.content.delivery.blinky_delivery_gen import BlinkyDelivery

from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.content.analytics.blinky_analytics_gen import BlinkyAnalytics

from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.content.acquisition.blinky_acquisition_gen import BlinkyAcquisition
...
class BlinkyContent(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkycontent').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.content.blinky_content_gen import BlinkyContent', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkycontent-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.system_defaults.content.blinky_content_gen import BlinkyContent', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.system_defaults.content.content_data_gen import ContentData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-system-defaults-content-blinky-content-gen", 
