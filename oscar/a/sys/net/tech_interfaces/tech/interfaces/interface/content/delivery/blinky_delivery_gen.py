...
class BlinkyDelivery(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkydelivery').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.content.delivery.blinky_delivery_gen import BlinkyDelivery', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkydelivery-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.content.delivery.blinky_delivery_gen import BlinkyDelivery', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.content.delivery.delivery_data_gen import DeliveryData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-content-delivery-blinky-delivery-gen", 
