...
class BlinkyAcquisition(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyacquisition').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.content.acquisition.blinky_acquisition_gen import BlinkyAcquisition', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyacquisition-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.content.acquisition.blinky_acquisition_gen import BlinkyAcquisition', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.content.acquisition.acquisition_data_gen import AcquisitionData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-content-acquisition-blinky-acquisition-gen", 
