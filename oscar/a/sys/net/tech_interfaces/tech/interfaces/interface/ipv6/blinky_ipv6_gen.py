...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.ipv6.ipv6_data_gen import Ipv6Data


from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv6.address.blinky_address_list_gen import BlinkyAddressList
...
class BlinkyIpv6(BlinkyContainer):
    ...
    def trxElementUpdateCandidate(self, trxElement, keyDepth):
        ...
        if (keyPath.isTagEqual(keyDepth, self.ourNamespace, self.ourXmlTagDefaultGateway)):
            if trxElement.getNewVal():
                ...
                self.myCandidateData.defaultGateway = (newValue.asIPv6())
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyipv6').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv6.blinky_ipv6_gen import BlinkyIpv6', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyipv6-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv6.blinky_ipv6_gen import BlinkyIpv6', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.ipv6.ipv6_data_gen import Ipv6Data", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-ipv6-blinky-ipv6-gen", 
    ...
    "descendants": [
        {
            ...
            "yangName": "address", 
            "importStatement": "from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv6.address.blinky_address_list_gen import BlinkyAddressList"
        }
    ], 
