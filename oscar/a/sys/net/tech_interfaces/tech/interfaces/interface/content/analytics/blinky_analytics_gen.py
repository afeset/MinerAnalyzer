...
class BlinkyAnalytics(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyanalytics').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.content.analytics.blinky_analytics_gen import BlinkyAnalytics', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyanalytics-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.content.analytics.blinky_analytics_gen import BlinkyAnalytics', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.content.analytics.analytics_data_gen import AnalyticsData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-content-analytics-blinky-analytics-gen", 
