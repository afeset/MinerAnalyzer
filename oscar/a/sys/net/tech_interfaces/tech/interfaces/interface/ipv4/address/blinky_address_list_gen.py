...
from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv4.address.blinky_address_gen import BlinkyAddress
...
class BlinkyAddressList(BlinkyList):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyaddresslist').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am list of: from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv4.address.blinky_address_gen import BlinkyAddress', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyaddresslist-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am list of: from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv4.address.blinky_address_gen import BlinkyAddress', keyPathRegistered, keyPath, keyDepth)
...
Extracted from the below data: 
{
    "node": {
        ...
        "namespace": "address", 
        "containerImportStatement": "from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv4.address.blinky_address_gen import BlinkyAddress", 
        "logGroupName": "blinky-address-list", 
        "className": "BlinkyAddressList", 
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-ipv4-address-blinky-address-list-gen", 
        "keyLeaf": {
            "varName": "address", 
