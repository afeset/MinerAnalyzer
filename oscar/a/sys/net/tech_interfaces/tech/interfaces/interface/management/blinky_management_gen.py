...
class BlinkyManagement(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkymanagement').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.management.blinky_management_gen import BlinkyManagement', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkymanagement-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.management.blinky_management_gen import BlinkyManagement', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.management.management_data_gen import ManagementData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-management-blinky-management-gen", 
