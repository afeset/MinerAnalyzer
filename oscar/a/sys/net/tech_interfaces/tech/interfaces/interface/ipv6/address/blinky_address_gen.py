...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.ipv6.address.address_data_gen import AddressData
...
class BlinkyAddress(BlinkyContainer):
    ...
    def isKeyPathRegistered (cls, logger, keyPath, keyDepth):
        ...
        logger('is-key-path-registered-blinkyaddress').debug3('isKeyPathRegistered() called. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv6.address.blinky_address_gen import BlinkyAddress', keyPath, keyDepth)
        ...
        logger('is-key-path-registered-blinkyaddress-done').debug3('isKeyPathRegistered() done. registered=%s. keyPath=%s, keyDepth=%d, I am: from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv6.address.blinky_address_gen import BlinkyAddress', keyPathRegistered, keyPath, keyDepth)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.ipv6.address.address_data_gen import AddressData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-ipv6-address-blinky-address-gen", 
        "importStatement": "from a.sys.net.tech_interfaces.tech.interfaces.interface.ipv6.address.blinky_address_gen import BlinkyAddress", 
