...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.ethernet.status.status_oper_data_gen import StatusOperData
...
class BlinkyOperStatus(BlinkyOperNode):
    ...
    _kCallpointName = "tech-interfaces-interface-ethernet-status-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-interfaces-interface-ethernet-status-callpoint"
    ...
    def setOperDataRequestedFields (self, operData, keyPath):
        ...
        if requestedKeyPath.isEqual(flattenedSelfKeyPath) or (requestedKeyPath.getLen() <= flattenedSelfKeyPath.getLen()):
            ...
            if requestedKeyPath.getLen() > flattenedSelfKeyPath.getLen():
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "mac-address"):
    ...
    def fillTagValues (self, keyPath, tagValueList, operData):
        ...
        if operData.isMacAddressRequested() and operData.hasMacAddress():
            ...
            tagValueList.push(("mac-address", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), val)
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.ethernet.status.status_oper_data_gen import StatusOperData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-ethernet-status-blinky-status-oper-gen", 
        "importStatement": "from a.sys.net.tech_interfaces.tech.interfaces.interface.ethernet.status.blinky_status_oper_gen import BlinkyOperStatus", 
        "callpointName": "tech-interfaces-interface-ethernet-status-callpoint", 
