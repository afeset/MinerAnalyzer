...
from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.connectivity_check.ipv6.counters.counters_oper_data_gen import CountersOperData
...
class BlinkyOperCounters(BlinkyOperNode):
    ...
    _kCallpointName = "tech-interfaces-interface-connectivity-check-ipv6-counters-callpoint"
    ...
    def __init__ (self, logger):
        ...
        self.kCallpointName = "tech-interfaces-interface-connectivity-check-ipv6-counters-callpoint"
    ...
    def setOperDataRequestedFields (self, operData, keyPath):
        ...
        if requestedKeyPath.isEqual(flattenedSelfKeyPath) or (requestedKeyPath.getLen() <= flattenedSelfKeyPath.getLen()):
            ...
            if requestedKeyPath.getLen() > flattenedSelfKeyPath.getLen():
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "neighbor-discovery-failures"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "neighbor-discovery-timeouts"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "neighbor-discovery-successes"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "ping-requests-sent"):
                    for logFunc in self._log("set-oper-data-requested-fields-pingrequestssent-requested").debug3Func(): logFunc(
                        "ping-requests-sent requested. requestedKeyPath=%s, operData=%s", requestedKeyPath, operData.debugStr(True))
                    operData.setPingRequestsSentRequested()
                
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "ping-failures"):
                    for logFunc in self._log("set-oper-data-requested-fields-pingfailures-requested").debug3Func(): logFunc(
                        "ping-failures requested. requestedKeyPath=%s, operData=%s", requestedKeyPath, operData.debugStr(True))
                    operData.setPingFailuresRequested()
                
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "ping-successes"):
                    for logFunc in self._log("set-oper-data-requested-fields-pingsuccesses-requested").debug3Func(): logFunc(
                        "ping-successes requested. requestedKeyPath=%s, operData=%s", requestedKeyPath, operData.debugStr(True))
                    operData.setPingSuccessesRequested()
                
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "neighbor-discovery-requests-sent"):
                ...
                if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "ping-timeouts"):
                    for logFunc in self._log("set-oper-data-requested-fields-pingtimeouts-requested").debug3Func(): logFunc(
                        "ping-timeouts requested. requestedKeyPath=%s, operData=%s", requestedKeyPath, operData.debugStr(True))
                    operData.setPingTimeoutsRequested()
    ...
    def fillTagValues (self, keyPath, tagValueList, operData):
        ...
        if operData.isNeighborDiscoveryFailuresRequested() and operData.hasNeighborDiscoveryFailures():
            ...
            tagValueList.push(("neighbor-discovery-failures", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), val)
        ...
        if operData.isNeighborDiscoveryTimeoutsRequested() and operData.hasNeighborDiscoveryTimeouts():
            ...
            tagValueList.push(("neighbor-discovery-timeouts", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), val)
        ...
        if operData.isNeighborDiscoverySuccessesRequested() and operData.hasNeighborDiscoverySuccesses():
            ...
            tagValueList.push(("neighbor-discovery-successes", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), val)
        
        if operData.isPingRequestsSentRequested() and operData.hasPingRequestsSent():
            val = Value()
            val.setInt64(operData.pingRequestsSent)
            tagValueList.push(("ping-requests-sent", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), val)
        
        if operData.isPingFailuresRequested() and operData.hasPingFailures():
            val = Value()
            val.setInt64(operData.pingFailures)
            tagValueList.push(("ping-failures", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), val)
        
        if operData.isPingSuccessesRequested() and operData.hasPingSuccesses():
            val = Value()
            val.setInt64(operData.pingSuccesses)
            tagValueList.push(("ping-successes", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), val)
        ...
        if operData.isNeighborDiscoveryRequestsSentRequested() and operData.hasNeighborDiscoveryRequestsSent():
            ...
            tagValueList.push(("neighbor-discovery-requests-sent", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), val)
        
        if operData.isPingTimeoutsRequested() and operData.hasPingTimeouts():
            val = Value()
            val.setInt64(operData.pingTimeouts)
            tagValueList.push(("ping-timeouts", "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces"), val)
    ...
    def fillValue (self, value, keyPath, operData):
        ...
        if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "ping-requests-sent"):
            if operData.isPingRequestsSentRequested():
                 if operData.hasPingRequestsSent():
                     value.setInt64(operData.pingRequestsSent)
                 else:
                     value.setEmpty()
        
        if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "ping-failures"):
            if operData.isPingFailuresRequested():
                 if operData.hasPingFailures():
                     value.setInt64(operData.pingFailures)
                 else:
                     value.setEmpty()
        
        if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "ping-successes"):
            if operData.isPingSuccessesRequested():
                 if operData.hasPingSuccesses():
                     value.setInt64(operData.pingSuccesses)
                 else:
                     value.setEmpty()
        ...
        if requestedKeyPath.isTagEqual(flattenedSelfKeyPath.getLen(), "http://qwilt.com/ns/yang/device/tech/qwilt-tech-interfaces", "ping-timeouts"):
            if operData.isPingTimeoutsRequested():
                 if operData.hasPingTimeouts():
                     value.setInt64(operData.pingTimeouts)
                 else:
                     value.setEmpty()
...
{
    "node": {
        "dataImportStatement": "from a.api.yang.modules.tech.common.qwilt_tech_interfaces.tech.interfaces.interface.connectivity_check.ipv6.counters.counters_oper_data_gen import CountersOperData", 
        ...
        "logModuleName": "a-sys-net-tech-interfaces-tech-interfaces-interface-connectivity-check-ipv6-counters-blinky-counters-oper-gen", 
        "importStatement": "from a.sys.net.tech_interfaces.tech.interfaces.interface.connectivity_check.ipv6.counters.blinky_counters_oper_gen import BlinkyOperCounters", 
        "callpointName": "tech-interfaces-interface-connectivity-check-ipv6-counters-callpoint", 
